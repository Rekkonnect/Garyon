...
namespace Garyon.Benchmarking.Extensions
{
    public class ArrayBinaryOperationsHelpersVector128 : ArrayManipulationExtensionsQualityControlAsset
    {
        ...
        #region NOR
        [Benchmark]
        [BenchmarkCategory("NOR Byte", "Unsafe Vector128")]
        public unsafe void NORByteArray()
        {
            fixed (byte* o = OriginalByteArray)
            fixed (byte* t = TargetByteArray)
                if (!NORArrayVector128Generic(o, t, mask, ArrayLength))
                    Throw<InstructionSetBenchmarkException>();
        }
        [Benchmark]
        [BenchmarkCategory("NOR Int16", "Unsafe Vector128")]
        ...
        [Benchmark]
        [BenchmarkCategory("NOR Int32", "Unsafe Vector128")]
        ...
        [Benchmark]
        [BenchmarkCategory("NOR Int64", "Unsafe Vector128")]
        ...
        [Benchmark]
        [BenchmarkCategory("NOR SByte", "Unsafe Vector128")]
        public unsafe void NORSByteArray()
        {
            fixed (sbyte* o = OriginalSByteArray)
            fixed (sbyte* t = TargetSByteArray)
                if (!NORArrayVector128Generic(o, t, (sbyte)mask, ArrayLength))
                    Throw<InstructionSetBenchmarkException>();
        }
        [Benchmark]
        [BenchmarkCategory("NOR UInt16", "Unsafe Vector128")]
        ...
        [Benchmark]
        [BenchmarkCategory("NOR UInt32", "Unsafe Vector128")]
        ...
        [Benchmark]
        [BenchmarkCategory("NOR UInt64", "Unsafe Vector128")]
        ...
        #region XNOR
        [Benchmark]
        [BenchmarkCategory("XNOR Byte", "Unsafe Vector128")]
        public unsafe void XNORByteArray()
        {
            fixed (byte* o = OriginalByteArray)
            fixed (byte* t = TargetByteArray)
                if (!XNORArrayVector128Generic(o, t, mask, ArrayLength))
                    Throw<InstructionSetBenchmarkException>();
        }
        [Benchmark]
        [BenchmarkCategory("XNOR Int16", "Unsafe Vector128")]
        ...
        [Benchmark]
        [BenchmarkCategory("XNOR Int32", "Unsafe Vector128")]
        ...
        [Benchmark]
        [BenchmarkCategory("XNOR Int64", "Unsafe Vector128")]
        ...
        [Benchmark]
        [BenchmarkCategory("XNOR SByte", "Unsafe Vector128")]
        public unsafe void XNORSByteArray()
        {
            fixed (sbyte* o = OriginalSByteArray)
            fixed (sbyte* t = TargetSByteArray)
                if (!XNORArrayVector128Generic(o, t, (sbyte)mask, ArrayLength))
                    Throw<InstructionSetBenchmarkException>();
        }
        [Benchmark]
        [BenchmarkCategory("XNOR UInt16", "Unsafe Vector128")]
        ...
        [Benchmark]
        [BenchmarkCategory("XNOR UInt32", "Unsafe Vector128")]
        ...
        [Benchmark]
        [BenchmarkCategory("XNOR UInt64", "Unsafe Vector128")]
