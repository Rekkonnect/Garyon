...
/// <summary>
/// A helper class providing tools for throwing exceptions. It should be
/// preferred to use in code that demands optimization.
/// </summary>
public static class ThrowHelper
{
    #region Generic Throwers
    /// <summary>
    /// Throws a new exception of the type <typeparamref name="T"/>.
    /// </summary>
    /// <typeparam name="T">
    /// The exception type to throw.
    /// </typeparam>
    /// <returns>
    /// Never reaches the point of returning; the return type is so that an
    /// object can be used in <see langword="return"/> or
    /// <see langword="throw"/> statements (latter is not recommended).
    /// </returns>
    [DoesNotReturn]
    ...
    /// <summary>
    /// Throws a new aggregate exception of the type <typeparamref name="T"/>.
    /// </summary>
    /// <typeparam name="T">
    /// The exception type to throw.
    /// </typeparam>
    ...
    /// </summary>
    /// <param name="e">
    /// The exception instance to throw.
    /// </param>
    /// <returns>
    /// Never reaches the point of returning; the return type is so that an
    /// object can be used in <see langword="return"/> or
    ...
    /// <summary>
    /// Throws a new <seealso cref="AggregateException"/>.
    /// </summary>
    /// <param name="message">
    /// The error message that explains the reason for the exception.
    /// </param>
    ...
    where TException : Exception, new()
{
    ...
    /// The return type that will be targeted.
    /// </typeparam>
    /// <returns>
