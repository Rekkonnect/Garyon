...
public static unsafe class Allocation
{
    ...
    /// </param>
    /// <returns>
    /// A <typeparamref name="T"/>* pointing to the start of the allocated
    /// block. The block's size is equal to the number of elements multiplied by
    ...
    /// <summary>
    /// Allocates a block of elements of a specified type
    /// <typeparamref name="T"/> from the unmanaged heap, and zeroes it.
    /// </summary>
    /// <typeparam name="T">
    /// The type of elements the allocated block will store.
    /// </typeparam>
    ...
    /// </param>
    /// <returns>
    /// A <see langword="void"/>* pointing to the start of the reallocated
    /// block.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    /// A <typeparamref name="T"/>* pointing to the start of the reallocated
    /// block. The block's size is equal to the number of elements multiplied by
    /// <see langword="sizeof"/>(<typeparamref name="T"/>).
    /// </returns>
    ...
    /// </summary>
    /// <param name="pointer">
    /// The <see langword="void"/>* pointing at the block that was allocated.
    /// </param>
