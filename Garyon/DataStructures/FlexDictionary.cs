    ...
    where TKey : notnull
{
    ...
    /// <seealso cref="FlexDictionary{TKey, TValue}"/> class with the default
    /// initial capacity (16).
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the
    /// <seealso cref="FlexDictionary{TKey, TValue}"/> class.
    /// </summary>
    /// <param name="capacity">
    ...
    /// <summary>
    /// Initializes a new instance of the
    /// <seealso cref="FlexDictionary{TKey, TValue}"/> class. Each item in the
    /// provided collection is added as a key and is mapped to the specified
    /// value of the <typeparamref name="TValue"/> type.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the
    /// <seealso cref="FlexDictionary{TKey, TValue}"/> class out of another
    /// <seealso cref="FlexDictionary{TKey, TValue}"/> instance.
    /// </summary>
    /// <param name="other">
    /// The other <seealso cref="FlexDictionary{TKey, TValue}"/> whose key-value
    /// pairs to copy.
    /// </param>
