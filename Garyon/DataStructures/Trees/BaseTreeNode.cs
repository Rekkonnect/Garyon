...
{
    /// <summary>
    /// The internal base tree. Prefer using this instead of calling the
    /// property for internal usage, unless the <see cref="BaseTree"/> setter is
    /// required.
    /// </summary>
    protected TTree InternalBaseTree;
    /// <summary>
    /// The internal parent. Prefer using this instead of calling the property
    /// for internal usage, unless the <see cref="Parent"/> setter is required.
    /// </summary>
    protected TTreeNode InternalParent;

    /// <summary>
    /// Gets this tree node instance as a <typeparamref name="TTreeNode"/>.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether this node is the root; that is, its parent is
    /// <see langword="null"/>.
    /// </summary>
    ...
    /// <summary>
    /// Gets the height of this tree node's base tree height. It is equal to the
    /// sum of this tree node's height and depth.
    /// </summary>
    ...
    /// <summary>
    /// Gets a node from the subtree with this tree node as a root node that has
    /// the specified value.
    /// </summary>
    /// <param name="value">
    ...
    /// <summary>
    /// Gets the first node that has the specified value from the specified
    /// collection.
    /// </summary>
    ...
    /// </param>
    /// <returns>
    /// The first node that was found in the collection, or
    ...
    /// <summary>
    /// Removes a node that has the specified value. This includes any node that
    /// is within the subtree with this tree node as the root.
    /// </summary>
    /// <param name="value">
    /// The value of the node to remove from this node's children list.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the child was successfully removed from this
    /// node's children list, otherwise <see langword="false"/>.
    /// </returns>
    ...
    /// <summary>
    /// Removes nodes that have the specified values. This includes any node
    /// that is within the subtree with this tree node as the root.
    /// </summary>
    /// <param name="values">
    /// The values of the child nodes to remove from this node's children list.
    /// </param>
    /// <returns>
    /// The number of nodes from the list that were removed.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the child was found and removed, otherwise
    /// <see langword="false"/>.
    /// </returns>
    ...
    /// <summary>
    /// Clones this <seealso cref="TreeNode{T}"/> and all its children
    /// recursively.
    /// </summary>
    /// <returns>
    /// The cloned <seealso cref="TreeNode{T}"/>. Its base tree is also equal to
    /// the original <seealso cref="TreeNode{T}"/>'s base tree.
    /// </returns>
    ...
    /// <summary>
    /// Clones this tree node's children to the cloned instance that is created
    /// within the <seealso cref="Clone()"/> method.
    /// </summary>
    /// <param name="result">
    /// The resulting instance to which to add the cloned children.
    /// </param>
    /// <remarks>
    /// The cloned children should also be cloned with the
    /// <seealso cref="Clone(bool)"/> method, but with the argument being
    /// <see langword="false"/>.
    /// </remarks>
    ...
    /// elements are returned with <see langword="yield return"/>.
    /// </summary>
    /// <returns>
    /// The yielded values.
    /// </returns>
    ...
    /// <summary>
    /// Traverses the subtree with this node as a root using pre-order. The
    /// nodes are returned with <see langword="yield return"/>.
    /// </summary>
    /// <returns>
    /// The yielded nodes.
    /// </returns>
    ...
    /// </summary>
    /// <returns>
    /// The <seealso cref="IEnumerator{T}"/> that traverses the subtree using
    /// pre-order traversal.
    /// </returns>
    ...
    /// </summary>
    /// <returns>
    /// The <seealso cref="IEnumerator"/> that traverses the subtree using
    /// pre-order traversal.
    /// </returns>
    IEnumerator IEnumerable.GetEnumerator() => GetEnumerator();

    /// <summary>
    /// Gets the hash code of this tree node, which is equal to the hash code of
