...
public class TreeNode<T> : TreeNode<T, Tree<T>, TreeNode<T>>
{
    ...
    /// with no base tree, parent or children nodes.
    /// </summary>
    /// <param name="value">
    ...
    /// <summary>
    /// Initializes a new instance of the <seealso cref="TreeNode{T}"/> class
    /// with a base tree, but no parent or children nodes.
    /// </summary>
    /// <param name="baseTree">
    ...
    /// <summary>
    /// Initializes a new instance of the <seealso cref="TreeNode{T}"/> class
    /// with a parent node, but no children nodes. The base tree is considered
    /// to be that of the parent.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <seealso cref="TreeNode{T}"/> class
    /// with a parent and children nodes. The base tree is considered to be that
    /// of the parent.
    /// </summary>
    /// <param name="parentNode">
    /// The parent node.
    ...
    where TTreeNode : TreeNode<TValue, TTree, TTreeNode>
{
    ...
    /// </param>
    /// <returns>
    /// The <seealso cref="TreeNode{T}"/> that was created and added to this
    ...
    /// <summary>
    /// Adds child nodes that have the specified values to the end of this
    /// node's children list.
    /// </summary>
    /// <param name="values">
    /// The values of the new child nodes to add to the end of this node's
    /// children list.
    /// </param>
    /// <returns>
