...
public interface ITreeNode<TValue> : IEnumerable<TValue>
{
    ...
    /// <summary>
    /// Gets the count of children of this node; prefer calling this property
    /// instead of getting the count directly from the respective property to
    ...
    /// sum of this tree node's height and depth. Prefer calling this instead of
    /// the <see cref="Height"/> property on
    /// <see cref="BaseTree{TValue, TTree, TTreeNode}.Root"/>.
    /// </summary>
    ...
    /// </summary>
    /// <returns>
    /// An <seealso cref="IEnumerable{T}"/> containing the yielded values.
    /// </returns>
    ...
    where TTreeNode : ITreeNode<TValue, TTree, TTreeNode>
{
    ...
    /// </param>
    /// <returns>
    /// The <typeparamref name="TTreeNode"/> with the specified value, if found;
    ...
    /// <summary>
    /// Clones this <typeparamref name="TTreeNode"/> and all its children
    /// recursively.
    /// </summary>
    /// <returns>
    /// The cloned <typeparamref name="TTreeNode"/>. Its base tree is also equal
    /// to the original <typeparamref name="TTreeNode"/>'s base tree.
    /// </returns>
    TTreeNode Clone();
    ...
    /// </summary>
    /// <returns>
    /// An <seealso cref="IEnumerable{T}"/> containing the yielded nodes.
    /// </returns>
