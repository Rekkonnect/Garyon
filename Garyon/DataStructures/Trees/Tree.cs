    ...
    where TTreeNode : TreeNode<TValue, TTree, TTreeNode>
{
    ...
    /// The values of the new children to set to the node.
    /// </param>
    /// <param name="propagate">
    /// Determines whether this function should propagate to the
    /// <seealso cref="TreeNode{TValue, TTree, TTreeNode}.Children"/> property
    /// by setting the property to <paramref name="newValues"/>. Only set this
    /// to <see langword="false"/> if the new children are already set in the
    ...
    /// The new children to set to the node.
    /// </param>
    /// <param name="propagate">
    /// Determines whether this function should propagate to the
    /// <seealso cref="TreeNode{TValue, TTree, TTreeNode}.Children"/> property
    /// by setting the property to <paramref name="newChildren"/>. Only set this
    /// to <see langword="false"/> if the new children are already set in the
    /// node before calling this function.
    /// </param>
    ...
    /// <param name="propagate">
    /// Determines whether this function should propagate to the
    /// <seealso cref="TreeNode{TValue, TTree, TTreeNode}.AddChild(TTreeNode)"/>
    ...
    /// </param>
    /// <param name="newChildren">
    /// The new children to add to the node.
    /// </param>
    /// <param name="propagate">
    /// Determines whether this function should propagate to the
    /// <seealso cref="TreeNode{TValue, TTree, TTreeNode}.AddChildren(IEnumerable{TTreeNode})"/>
    /// function. Only set this to <see langword="false"/> if the new child was
    /// already added before calling this function.
    /// </param>
    ...
    /// <param name="propagate">
    /// Determines whether this function should propagate to the
    /// <seealso cref="TreeNode{TValue, TTree, TTreeNode}.RemoveChildren(IEnumerable{TTreeNode})"/>
    /// function. Only set this to <see langword="false"/> if the new child was
    /// already added before calling this function.
    /// </param>
