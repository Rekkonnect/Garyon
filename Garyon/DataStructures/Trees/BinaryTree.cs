...
{
    /// <summary>
    /// Initializes a new instance of the <seealso cref="BinaryTree{T}"/> class
    /// with no root node.
    /// </summary>
    public BinaryTree()
        : base() { }
    ...
    /// <inheritdoc/>
    protected override BinaryTreeNode<T> InitializeNewNode(T value = default) => new(value);
    /// <inheritdoc/>
    protected override BinaryTreeNode<T> InitializeNewNode(BinaryTree<T> baseTree, T value = default) => new(baseTree, value);
    /// <inheritdoc/>
    protected override BinaryTreeNode<T> InitializeNewNode(BinaryTreeNode<T> parentNode, T value = default) => new(parentNode, value);
    #endregion
}
...
/// The type of the binary tree nodes that are used in the
/// <typeparamref name="TTree"/> type.
/// </typeparam>
    ...
    where TTreeNode : BinaryTreeNode<TValue, TTree, TTreeNode>
{
    ...
    /// <seealso cref="BinaryTree{TValue, TTree, TTreeNode}"/> class with no
    /// root node.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the
    /// <seealso cref="BinaryTree{TValue, TTree, TTreeNode}"/> class with a root
    /// value.
    /// </summary>
    /// <param name="rootValue">
    /// The value of the root node.
    ...
    /// <summary>
    /// Initializes a new instance of the
    /// <seealso cref="BinaryTree{TValue, TTree, TTreeNode}"/> class from a
    /// different tree.
    /// </summary>
    /// <param name="tree">
    /// The tree to create this tree from. Both trees remain independent.
    ...
    /// </summary>
    /// <param name="value">
    /// The value of the parent node whose children to set. The node must be
    /// within this tree.
    /// </param>
    ...
    /// <seealso cref="BinaryTreeNode{TValue, TTree, TTreeNode}.LeftChild"/> and
    /// <seealso cref="BinaryTreeNode{TValue, TTree, TTreeNode}.RightChild"/>
    /// properties by setting the property to <paramref name="leftChild"/>. Only
    /// set this to <see langword="false"/> if the new children are already set
    /// in the node before calling this function.
    /// </param>
    ...
    /// <seealso cref="BinaryTreeNode{TValue, TTree, TTreeNode}.LeftChild"/> and
    /// <seealso cref="BinaryTreeNode{TValue, TTree, TTreeNode}.RightChild"/>
    /// properties by setting the property to <paramref name="leftChild"/> and
    /// <paramref name="rightChild"/> respectively. Only set this to
    /// <see langword="false"/> if the new children are already set in the node
    ...
    /// <param name="propagate">
    /// Determines whether this function should propagate to the
    /// <seealso cref="BinaryTreeNode{TValue, TTree, TTreeNode}.AddChild(TTreeNode)"/>
    ...
    /// </summary>
    /// <param name="node">
    /// The parent node whose children to add. The node must be within this
    /// tree.
    /// </param>
    /// <param name="leftChild">
    ...
    /// <param name="propagate">
    /// Determines whether this function should propagate to the
    /// <seealso cref="BinaryTreeNode{TValue, TTree, TTreeNode}.AddChildren(TTreeNode, TTreeNode)"/>
    /// function. Only set this to <see langword="false"/> if the new child was
    /// already added before calling this function.
    /// </param>
    ...
    /// </summary>
    /// <param name="childrenToRemove">
    /// The children to remove from the tree root node.
    /// </param>
    /// <param name="propagate">
    /// Determines whether this function should propagate to the
    /// <seealso cref="BinaryTreeNode{TValue, TTree, TTreeNode}.RemoveChildren(IEnumerable{TTreeNode})"/>
    /// function. Only set this to <see langword="false"/> if the new child was
    /// already added before calling this function.
    /// </param>
    ...
    /// <param name="propagate">
    /// Determines whether this function should propagate to the
    /// <seealso cref="BinaryTreeNode{TValue, TTree, TTreeNode}.RemoveChildren(IEnumerable{TValue})"/>
    /// function. Only set this to <see langword="false"/> if the new child was
    /// already added before calling this function.
    /// </param>
