...
/// <summary>
/// Represents a binary tree node, which is a component that is contained within
/// a binary tree.
/// </summary>
/// <typeparam name="T">
...
{
    /// <summary>
    /// Initializes a new instance of the <seealso cref="BinaryTreeNode{T}"/>
    /// class with no base tree, parent or children nodes.
    /// </summary>
    /// <param name="value">
    ...
    /// <summary>
    /// Initializes a new instance of the <seealso cref="BinaryTreeNode{T}"/>
    /// class with a base tree, but no parent or children nodes.
    /// </summary>
    /// <param name="baseTree">
    ...
    /// <summary>
    /// Initializes a new instance of the <seealso cref="BinaryTreeNode{T}"/>
    /// class with a parent node, but no children nodes. The base tree is
    /// considered to be that of the parent.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <seealso cref="BinaryTreeNode{T}"/>
    /// class with a parent and children nodes. The base tree is considered to
...
{
    /// <summary>
    /// The left child of this node. This internal field is exposed to avoid
    /// using the property setters.
    /// </summary>
    protected TTreeNode InternalLeftChild;
    /// <summary>
    /// The right child of this node. This internal field is exposed to avoid
    /// using the property setters.
    /// </summary>
    ...
    /// new list created based on the left and right children of this node,
    /// therefore it is best to call this property as less as possible.
    /// </summary>
    /// <value>
    ...
    /// </param>
    /// <returns>
    /// The <seealso cref="BinaryTreeNode{T}"/> with the specified value, if
    ...
    /// <summary>
    /// Adds a child node that has the specified value to the end of this node's
    /// children list.
    /// </summary>
    /// <param name="value">
    /// The value of the new child node to add to the end of this node's
    /// children list.
    /// </param>
    /// <returns>
    /// The <seealso cref="BinaryTreeNode{T}"/> that was created and added to
    ...
    /// are returned with <see langword="yield return"/>.
    /// </summary>
    /// <returns>
    /// The yielded nodes.
    /// </returns>
    ...
    public override IEnumerable<TTreeNode> TraverseLevelOrderNodes()
    {
        ...
        // INSPIRATION: Data structure for swappable lists, minimizing allocations
