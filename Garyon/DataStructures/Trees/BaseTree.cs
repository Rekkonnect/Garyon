    ...
    where TTreeNode : BaseTreeNode<TValue, TTree, TTreeNode>
{
    ...
    /// </para>
    /// <para>
    /// It is <see langword="null"/> if the element count has never been
    /// calculated.
    /// </para>
    /// <para>
    /// If the value is not <see langword="null"/> and any modification occurs,
    /// it will be set to <see langword="null"/>.
    /// </para>
    /// </summary>
    protected int? CachedCount;
    /// <summary>
    /// The internal field for the root of this tree. If no side-effects are
    /// bound to occur, prefer setting this over the <see cref="Root"/>
    /// property.
    /// </summary>
    protected TTreeNode InternalRoot;

    /// <summary>
    /// Gets this tree node instance as a <typeparamref name="TTree"/>.
    /// </summary>
    ...
    /// <summary>
    /// Gets the number of elements that this tree has. The count is only
    /// calculated upon the first request after any adjustments that were made
    /// to the tree.
    /// </summary>
    public int Count
    {
    ...
    /// <summary>
    /// Gets the height of this tree. It is equal to the height of the root
    /// node.
    /// </summary>
    public int Height => Root.Height;
    /// <summary>
    /// Gets the breadth of this tree. It is equal to the breadth of the root
    /// node.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <seealso cref="Tree{T}"/> class with
    /// no root node.
    /// </summary>
    public BaseTree() { }
    /// <summary>
    /// Initializes a new instance of the <seealso cref="Tree{T}"/> class with a
    /// root value.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <seealso cref="Tree{T}"/> class from a
    /// different tree.
    /// </summary>
    /// <param name="tree">
    ...
    /// <summary>
    /// Initializes a new instance of the <seealso cref="TreeNode{T}"/> class
    /// with no base tree or parent node.
    /// </summary>
    /// <param name="value">
    ...
    /// <summary>
    /// Initializes a new instance of the <seealso cref="TreeNode{T}"/> class
    /// with a base tree, but no parent node.
    /// </summary>
    /// <param name="baseTree">
    ...
    /// <summary>
    /// Initializes a new instance of the <seealso cref="TreeNode{T}"/> class
    /// with a parent node. The base tree is considered to be that of the
    /// parent.
    /// </summary>
    ...
    /// </param>
    /// <returns>
    /// The <seealso cref="TreeNode{T}"/> with the specified value, if found;
    ...
    /// Determines whether this function should propagate to the
    /// <seealso cref="BaseTreeNode{TValue, TTree, TTreeNode}.RemoveChild(TTreeNode)"/>
    /// function. Only set this to <see langword="false"/> if the new child was
    /// already added before calling this function.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the node was successfully removed, otherwise
    /// <see langword="false"/>.
    /// </returns>
    ...
    /// <summary>
    /// Removes nodes within a subtree with root as the specified node that
    /// contain the specified values.
    /// </summary>
    /// <param name="node">
    /// The node which is the root of the subtree in which to remove the nodes
    /// at.
    /// </param>
    /// <param name="values">
    /// The values of the children to remove.
    ...
    /// </summary>
    /// <param name="node">
    /// The parent node whose children to set. The node must be within this
    /// tree.
    /// </param>
    /// <param name="childToRemove">
    /// The child to remove from the node.
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the child was successfully removed from the
    ...
    /// <summary>
    /// Removes a node from the tree that has the value that is equal to the
    /// provided value.
    /// </summary>
    /// <param name="value">
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the node with the requested value was found
    ...
    /// <summary>
    /// Clears the children of a node with the specified value, that is within
    /// this tree.
    /// </summary>
    /// <param name="value">
    /// The value of the parent node whose children to clear. The node must be
    /// within this tree.
    /// </param>
    /// <param name="propagate">
    /// Determines whether this function should propagate to the
    /// <seealso cref="BaseTreeNode{TValue, TTree, TTreeNode}.Children"/>
    /// property. Only set this to <see langword="false"/> if the new children
    /// are already set in the node before calling this function.
    /// </param>
    ...
    /// </summary>
    /// <param name="node">
    /// The parent node whose children to clear. The node must be within this
    /// tree.
    /// </param>
    /// <param name="propagate">
    /// Determines whether this function should propagate to the
    ...
    /// <summary>
    /// Performs some operations to prepare for any children adjustment
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the operation can be performed, otherwise
    /// <see langword="false"/>. This requires <paramref name="node"/> to not be
    /// <see langword="null"/> and belong to this tree.
    /// </returns>
    ...
    /// returned with <see langword="yield return"/>.
    /// </summary>
    /// <returns>
    /// The yielded values.
    /// </returns>
    ...
    /// with <see langword="yield return"/>.
    /// </summary>
    /// <returns>
    /// The yielded nodes.
    /// </returns>
    ...
    /// </summary>
    /// <returns>
    /// The <seealso cref="IEnumerator{T}"/> that traverses the tree using
    /// pre-order traversal.
    /// </returns>
    ...
    /// </summary>
    /// <returns>
    /// The <seealso cref="IEnumerator"/> that traverses the tree using
    /// pre-order traversal.
    /// </returns>
