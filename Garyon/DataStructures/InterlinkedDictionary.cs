...
// TODO: Provide a same-type interlinked dictionary type

/// <summary>
/// Represents a collection of interlinked key-value pairs, where both the key
/// and the value are mapped to each other. This means that the ability to get
/// the mapping key from the mapped value is enabled.
/// </summary>
/// <typeparam name="T1">
    ...
    where T2 : notnull
{
    ...
    /// <summary>
    /// Gets all the currently stored values of type <typeparamref name="T1"/>.
    /// </summary>
    public IEnumerable<T1> Values1 => t1Dictionary.Keys;
    /// <summary>
    /// Gets all the currently stored values of type <typeparamref name="T2"/>.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new empty <seealso cref="InterlinkedDictionary{T1, T2}"/>.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new <seealso cref="InterlinkedDictionary{T1, T2}"/> out of
    /// another, copying the pairs to this new instance.
    /// </summary>
    /// <param name="other">
    /// The other <see cref="InterlinkedDictionary{T1, T2}"/> from which to copy
    /// the pairs. That instance remains unaffected upon performing operations
    /// on this new one.
    /// </param>
    ...
    /// </summary>
    /// <param name="value">
    /// The value of type <typeparamref name="T1"/> that may be contained.
    /// </param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="value">
    /// The value of type <typeparamref name="T2"/> that may be contained.
    /// </param>
    /// <returns>
    /// A value determining whether the value is contained.
    /// </returns>
    ...
    /// <summary>
    /// Adds a pair of values to the dictionary. If any of the values already
    /// exists,
    /// </summary>
    /// <param name="t1Value">
    /// The value of type <typeparamref name="T1"/> to add to the dictionary.
    /// </param>
    /// <param name="t2Value">
    /// The value of type <typeparamref name="T2"/> to add to the dictionary.
    /// </param>
    ...
    /// </summary>
    /// <param name="t1Value">
    /// The value of type <typeparamref name="T1"/> that will be removed.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the value was found and successfully removed
    /// from the dictionary, otherwise <see langword="false"/>.
    /// </returns>
    ...
    /// </summary>
    /// <param name="t2Value">
    /// The value of type <typeparamref name="T2"/> that will be removed.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the value was found and successfully removed
    /// from the dictionary, otherwise <see langword="false"/>.
    ...
    /// <summary>
    /// Clears the dictionary, removing all pairs of values that are currently
    /// stored.
    /// </summary>
    public void Clear()
    {
    ...
    /// </summary>
    /// <param name="t1Key">
    /// The value of type <typeparamref name="T1"/> whose paired value to get.
    /// </param>
    /// <param name="t2Value">
    /// The paired value of type <typeparamref name="T2"/>, if
    /// <paramref name="t1Key"/> exists in the dictionary, otherwise
    /// <see langword="default"/>.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the value was present in the dictionary,
    ...
    /// </summary>
    /// <param name="t2Key">
    /// The value of type <typeparamref name="T2"/> whose paired value to get.
    /// </param>
    /// <param name="t1Value">
    /// The paired value of type <typeparamref name="T1"/>, if
    /// <paramref name="t2Key"/> exists in the dictionary, otherwise
    /// <see langword="default"/>.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the value was present in the dictionary,
    ...
    /// </param>
    /// <returns>
    /// The paired value of type <typeparamref name="T2"/>, if the value of type
    /// <typeparamref name="T1"/> exists, otherwise <see langword="default"/>.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    /// The paired value of type <typeparamref name="T1"/>, if the value of type
    /// <typeparamref name="T2"/> exists, otherwise <see langword="default"/>.
    /// </returns>
    ...
    /// </summary>
    /// <param name="t1Key">
    /// The value of type <typeparamref name="T1"/> whose paired value to get or
    /// set.
    /// </param>
    /// <returns>
    /// The paired value of type <typeparamref name="T2"/>, if the value of type
    /// <typeparamref name="T1"/> exists.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    /// Thrown if the given value of type <typeparamref name="T1"/> is
    /// <see langword="null"/>.
    /// </exception>
    /// <exception cref="KeyNotFoundException">
    /// Thrown if the given value of type <typeparamref name="T1"/> does not
    ...
    /// </summary>
    /// <param name="t2Key">
    /// The value of type <typeparamref name="T2"/> whose paired value to get or
    /// set.
    /// </param>
    /// <returns>
    /// The paired value of type <typeparamref name="T1"/>, if the value of type
    /// <typeparamref name="T2"/> exists.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    /// Thrown if the given value of type <typeparamref name="T2"/> is
    /// <see langword="null"/>.
    /// </exception>
    /// <exception cref="KeyNotFoundException">
    /// Thrown if the given value of type <typeparamref name="T2"/> does not
    /// exist in the dictionary.
    /// </exception>
    ...
    private static void ChangeValue<TFocused, TOther>(
        Dictionary<TFocused, TOther> focusedDictionary,
        Dictionary<TOther, TFocused> otherDictionary,
        TFocused key,
        TOther value)
        where TFocused : notnull
