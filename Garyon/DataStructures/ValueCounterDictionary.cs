...
/// <summary>
/// Represents a value counter dictionary, that stores a counter per entry as
    ...
    where TKey : notnull
{
    ...
    /// <seealso cref="ValueCounterDictionary{TKey}"/> class with the default
    /// initial capacity (16).
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the
    /// <seealso cref="ValueCounterDictionary{TKey}"/> class.
    /// </summary>
    /// <param name="capacity">
    ...
    /// <summary>
    /// Initializes a new instance of the
    /// <seealso cref="ValueCounterDictionary{TKey}"/> class. Each item in the
    /// provided collection is added as a key and is mapped to the value of 1.
    /// </summary>
    ...
    /// <seealso cref="ValueCounterDictionary{TKey}"/> instance.
    /// </summary>
    /// <param name="other">
    /// The other <seealso cref="ValueCounterDictionary{TKey}"/> whose key-value
    /// pairs to copy.
    /// </param>
    ...
    /// <summary>
    /// Subtracts a value from the counter of one key and adds that value on the
    /// counter of another key.
    /// </summary>
    /// <param name="from">
