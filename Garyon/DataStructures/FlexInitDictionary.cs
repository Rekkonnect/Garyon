...
public class FlexInitDictionary<TKey, TValue>
    ...
    where TValue : new()
{
    /// <summary>Initializes a new instance of the <seealso cref="FlexInitDictionary{TKey, TValue}"/> class with the default initial capacity (16).</summary>
    ...
    public FlexInitDictionary(IEnumerable<KeyValuePair<TKey, TValue>> kvps)
        : base(kvps) { }
#endif
    /// <summary>Initializes a new instance of the <seealso cref="FlexInitDictionary{TKey, TValue}"/> class out of another <seealso cref="FlexInitDictionary{TKey, TValue}"/> instance.</summary>
    /// <param name="other">The other <seealso cref="FlexInitDictionary{TKey, TValue}"/> whose key-value pairs to copy.</param>
