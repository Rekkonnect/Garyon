...
/// <summary>
/// Represents a set whose elements are stored in a stack. This data structure
/// encapsulates a <seealso cref="Stack{T}"/> and a
...
public sealed class StackSet<T> : BaseSetLinearCollection<T>
{
    ...
    /// <summary>
    /// Initializes a new empty instance of the <seealso cref="StackSet{T}"/>
    /// class.
    /// </summary>
    public StackSet()
        : base()
    ...
    /// stack set and was successfully pushed, otherwise
    /// <see langword="false"/>.
    /// </returns>
    ...
    /// <summary>
    /// Pushes a collection of items to the stack set. The order at which each
    /// item is pushed is determined by the enumeration order of the provided
    /// collection.
    /// </summary>
    /// <param name="items">
    /// The collection of items to push to the stack set.
    /// </param>
    ...
    /// <summary>
    /// Pops a number of items from the stack set, and returns them in the order
    /// they were popped.
    /// </summary>
    /// <param name="count">
    /// The number of items to pop from the stack set. If the stack set contains
    /// less items than the provided count, it will be capped to the current
    /// item count.
    /// </param>
    /// <returns>
    ...
    /// <summary>
    /// Gets the enumerator for this stack set, which is the enumerator for the
    /// stack.
    /// </summary>
    /// <returns>
