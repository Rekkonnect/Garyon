...
#pragma warning disable CS8524 // The switch expression does not handle some values of its input type (it is not exhaustive) involving an unnamed enum value.
    ...
    /// <summary>
    /// Transforms all elements of the collection to <seealso cref="int"/>, and
    /// gets the extremum of the transformed collection.
    /// </summary>
    /// <typeparam name="T">
    /// The type of elements stored in the collection.
    /// </typeparam>
    ...
    /// </param>
    /// <param name="selector">
    /// The selector function that transforms every element of the collection
    /// into <seealso cref="int"/>.
    /// </param>
    /// <returns>
    ...
    /// <summary>
    /// Transforms all elements of the collection to <seealso cref="long"/>, and
    /// gets the extremum of the transformed collection.
    /// </summary>
    /// <typeparam name="T">
    /// The type of elements stored in the collection.
    ...
    /// <summary>
    /// Transforms all elements of the collection to <seealso cref="long"/>?,
    /// and gets the extremum of the transformed collection.
    /// </summary>
    /// <typeparam name="T">
    /// The type of elements stored in the collection.
    /// </typeparam>
    ...
    /// <summary>
    /// Transforms all elements of the collection to <seealso cref="float"/>,
    /// and gets the extremum of the transformed collection.
    /// </summary>
    /// <typeparam name="T">
    /// The type of elements stored in the collection.
    ...
    /// <summary>
    /// Transforms all elements of the collection to <seealso cref="double"/>,
    /// and gets the extremum of the transformed collection.
    /// </summary>
    /// <typeparam name="T">
    /// The type of elements stored in the collection.
    ...
    /// <summary>
    /// Transforms all elements of the collection to <seealso cref="decimal"/>,
    /// and gets the extremum of the transformed collection.
    /// </summary>
    /// <typeparam name="T">
    /// The type of elements stored in the collection.
    ...
    /// <typeparamref name="TResult"/>?, and gets the extremum of the
