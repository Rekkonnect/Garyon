...
/// <summary>
/// Provides extensions for the <see cref="Stream"/> class.
/// </summary>
public static unsafe class StreamExtensions
{
    #region Property-like extensions
    /// <summary>
    /// Determines whether a <seealso cref="Stream"/> has reached its end.
    /// </summary>
    /// <param name="stream">
    /// The <seealso cref="Stream"/> whose position to check.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if <seealso cref="Stream.Position"/> &gt;=
    /// <see cref="Stream.Length"/>, otherwise <see langword="false"/>.
    /// </returns>
    public static bool ReachedEnd(this Stream stream) => stream.Position >= stream.Length;
    /// <summary>
    /// Calculates the remaining number of bytes that can be read from the
    /// <seealso cref="Stream"/> before reaching its end.
    /// </summary>
    /// <param name="stream">
    /// The <seealso cref="Stream"/> whose remaining byte count to calculate.
    /// </param>
    /// <returns>
    /// The number of bytes that can be read from the <seealso cref="Stream"/>
    ...
    /// </summary>
    /// <param name="stream">
    /// The <see cref="Stream"/> whose position to set to 0.
    /// </param>
    ...
    /// <summary>
    /// Reads all the contents of the stream and stores them to a newly
    /// initialized <seealso cref="byte"/> array.
    /// </summary>
    /// <param name="stream">
    /// The stream whose contents will be read and written into the target
    /// array.
    /// </param>
    /// <returns>
    /// The newly created <seealso cref="byte"/> array containing the read
    /// contents of the <seealso cref="Stream"/>.
    /// </returns>
    /// <remarks>
    /// Be careful when using this method on very large streams, all the
    /// contents will be copied over to the memory, which is far more limited
    /// than storage.
    /// </remarks>
...
#pragma warning restore CA2022 // Avoid inexact read with 'Stream.Read'
    ...
    /// <summary>
    /// Writes a <seealso cref="byte"/> to the stream at the current position.
    /// </summary>
    /// <param name="stream">
    ...
    /// <summary>
    /// Writes a <seealso cref="short"/> to the stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    /// </param>
    ...
    /// <summary>
    /// Writes a <seealso cref="int"/> to the stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    /// </param>
    ...
    /// <summary>
    /// Writes a <seealso cref="long"/> to the stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    /// </param>
    ...
    /// <summary>
    /// Writes a <seealso cref="sbyte"/> to the stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    /// </param>
    ...
    /// <summary>
    /// Writes a <seealso cref="ushort"/> to the stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    /// </param>
    ...
    /// <summary>
    /// Writes a <seealso cref="uint"/> to the stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    /// </param>
    ...
    /// <summary>
    /// Writes a <seealso cref="ulong"/> to the stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    /// </param>
    ...
    /// <summary>
    /// Writes all contents of a <seealso cref="byte"/> buffer to the stream at
    ...
    /// <summary>
    /// Writes a <seealso cref="string"/> encoded in UTF-8 to the stream at the
    /// current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    ...
    /// <summary>
    /// Writes a <seealso cref="string"/> encoded in Unicode (UTF-16) to the
    ...
    /// <summary>
    /// Writes a <seealso cref="string"/> encoded in UTF-32 to the stream at the
    /// current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    ...
    /// <summary>
    /// Writes a <seealso cref="string"/> encoded in ASCII to the stream at the
    /// current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    ...
    /// <summary>
    /// Writes a <seealso cref="string"/> encoded in a specified encoding to the
    /// stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    ...
    /// <summary>
    /// Writes a <seealso cref="byte"/>[] to the stream at the specified
    /// position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    ...
    /// <summary>
    /// Writes a <seealso cref="byte"/> to the stream at the specified position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    /// </param>
    ...
    /// <summary>
    /// Writes a <seealso cref="short"/> to the stream at the specified
    /// position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    ...
    /// <summary>
    /// Writes an <seealso cref="int"/> to the stream at the specified position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    /// </param>
    ...
    /// <summary>
    /// Writes a <seealso cref="long"/> to the stream at the specified position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    /// </param>
    ...
    /// <summary>
    /// Writes a <seealso cref="sbyte"/> to the stream at the specified
    /// position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    ...
    /// <summary>
    /// Writes a <seealso cref="ushort"/> to the stream at the specified
    /// position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    ...
    /// <summary>
    /// Writes a <seealso cref="uint"/> to the stream at the specified position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    /// </param>
    ...
    /// <summary>
    /// Writes a <seealso cref="ulong"/> to the stream at the specified
    /// position.
    /// </summary>
    /// <param name="stream">
    /// The stream to write to.
    ...
    /// <summary>
    /// Reads a <seealso cref="byte"/> from the stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    /// </param>
    /// <param name="value">
    /// The value. Its value is always equal to the first byte of the
    /// <seealso cref="int"/> that <seealso cref="Stream.ReadByte()"/> returns.
    /// Only use the value if the method returns <see langword="true"/>.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the <seealso cref="byte"/> was successfully
    /// read from the stream, otherwise <see langword="false"/>, if the stream
    /// has reached its end.
    /// </returns>
    ...
    /// <summary>
    /// Reads a <seealso cref="sbyte"/> from the stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    /// </param>
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the <seealso cref="sbyte"/> was successfully
    /// read from the stream, otherwise <see langword="false"/>, if the stream
    /// has reached its end.
    /// </returns>
    ...
    /// <summary>
    /// Reads a <seealso cref="short"/> from the stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    /// </param>
    /// <param name="value">
    /// The value. Its value is always equal to the buffer after calling the
    /// <seealso cref="Stream.Read(Span{byte})"/> function on it. Only use the
    /// value if the method returns <see langword="true"/>.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the <seealso cref="short"/> was successfully
    /// read from the stream, otherwise <see langword="false"/>, if the stream
    /// has reached its end.
    /// </returns>
    public static bool TryReadInt16<T>(this Stream stream, out short value) => TryReadValue(stream, out value);
    /// <summary>
    /// Reads a <seealso cref="ushort"/> from the stream at the current
    /// position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the <seealso cref="ushort"/> was successfully
    /// read from the stream, otherwise <see langword="false"/>, if the stream
    /// has reached its end.
    /// </returns>
    public static bool TryReadUInt16(this Stream stream, out ushort value) => TryReadValue(stream, out value);
    /// <summary>
    /// Reads an <seealso cref="int"/> from the stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    /// </param>
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the <seealso cref="int"/> was successfully
    /// read from the stream, otherwise <see langword="false"/>, if the stream
    /// has reached its end.
    /// </returns>
    public static bool TryReadInt32(this Stream stream, out int value) => TryReadValue(stream, out value);
    /// <summary>
    /// Reads a <seealso cref="uint"/> from the stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    /// </param>
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the <seealso cref="uint"/> was successfully
    /// read from the stream, otherwise <see langword="false"/>, if the stream
    /// has reached its end.
    /// </returns>
    public static bool TryReadUInt32(this Stream stream, out uint value) => TryReadValue(stream, out value);
    /// <summary>
    /// Reads a <seealso cref="long"/> from the stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    /// </param>
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the <seealso cref="long"/> was successfully
    /// read from the stream, otherwise <see langword="false"/>, if the stream
    /// has reached its end.
    /// </returns>
    public static bool TryReadInt64(this Stream stream, out long value) => TryReadValue(stream, out value);
    /// <summary>
    /// Reads a <seealso cref="ulong"/> from the stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    /// </param>
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the <seealso cref="ulong"/> was successfully
    /// read from the stream, otherwise <see langword="false"/>, if the stream
    /// has reached its end.
    /// </returns>
    ...
    /// <summary>
    /// Reads a <typeparamref name="T"/> from the stream at the current
    /// position.
    /// </summary>
    /// <typeparam name="T">
    ...
    /// <summary>
    /// Reads a <seealso cref="string"/> encoded in UTF-8 from the stream at the
    /// current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    ...
    /// The number of bytes to read. This does not necessarily equal the number
    /// of characters the resulting <seealso cref="string"/> contains.
    /// </param>
    /// <returns>
    /// The read <seealso cref="string"/> from the stream in the provided
    /// encoding.
    /// </returns>
    public static string ReadUTF8String(this Stream stream, long byteLength) => ReadString(stream, byteLength, Encoding.UTF8);
    /// <summary>
    /// Reads a <seealso cref="string"/> encoded in Unicode (UTF-16) from the
    /// stream at the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    ...
    /// <summary>
    /// Reads a <seealso cref="string"/> encoded in UTF-32 from the stream at
    /// the current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    ...
    /// <summary>
    /// Reads a <seealso cref="string"/> encoded in ASCII from the stream at the
    /// current position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    ...
    /// <summary>
    /// Reads a <seealso cref="string"/> encoded in a specified encoding from
    ...
    /// <summary>
    /// Reads a <seealso cref="byte"/> from the stream at the specified
    /// position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    ...
    /// <summary>
    /// Reads a <seealso cref="sbyte"/> from the stream at the specified
    /// position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    ...
    /// <summary>
    /// Reads a <seealso cref="short"/> from the stream at the specified
    /// position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    ...
    /// <summary>
    /// Reads a <seealso cref="ushort"/> from the stream at the specified
    /// position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    ...
    /// <summary>
    /// Reads an <seealso cref="int"/> from the stream at the specified
    /// position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    ...
    /// <summary>
    /// Reads a <seealso cref="uint"/> from the stream at the specified
    /// position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    ...
    /// <summary>
    /// Reads a <seealso cref="long"/> from the stream at the specified
    /// position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    ...
    /// <summary>
    /// Reads a <seealso cref="ulong"/> from the stream at the specified
    /// position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    ...
    /// <summary>
    /// Reads a <typeparamref name="T"/> from the stream at the specified
    /// position.
    /// </summary>
    /// <typeparam name="T">
    /// The type of the value to read.
    ...
    /// <summary>
    /// Reads a <seealso cref="string"/> encoded in a specified encoding from
    /// the stream at the specified position.
    /// </summary>
    /// <param name="stream">
    /// The stream to read from.
    /// </param>
