...
{
    /// <summary>
    /// Concatenates multiple <seealso cref="IEnumerable{T}"/>s and returns the
    /// concatenated result.
    /// </summary>
    /// <typeparam name="T">
    /// The type of the elements the <seealso cref="IEnumerable{T}"/>s hold.
    /// </typeparam>
    /// <param name="source">
    /// The source <seealso cref="IEnumerable{T}"/> to concatenate with the
    /// others.
    /// </param>
    /// <param name="others">
    /// The other <seealso cref="IEnumerable{T}"/>s to concatenate.
    /// </param>
    ...
    /// <summary>
    /// Flattens a collection of collections into a single collection. The
    /// resulting elements are contained in the order they are enumerated
    /// depth-first.
    /// </summary>
    /// <typeparam name="T">
    ...
    /// <summary>
    /// Flattens a collection of collections of collections into a single
    /// collection. The resulting elements are contained in the order they are
    /// enumerated depth-first.
    /// </summary>
    /// <typeparam name="T">
    /// The type of elements contained in the collections.
    /// </typeparam>
    ...
    /// </returns>
    /// <remarks>
    /// The function enumerates all the elements and caches them. This may
    /// induce a latency during enumeration of the collections. Prefer calling
    /// this function when enumeration of the same flattened collections is
