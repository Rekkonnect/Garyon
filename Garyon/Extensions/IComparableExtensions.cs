...
/// <summary>
/// Provides extension methods for the <seealso cref="IComparable"/> and
/// <seealso cref="IComparable{T}"/> interfaces.
/// </summary>
public static class IComparableExtensions
{
    #region IComparable
    /// <summary>
    /// Determines whether <paramref name="value"/> is less than
    /// <paramref name="other"/>.
    /// </summary>
    /// <param name="value">
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if <paramref name="value"/> is less than
    ...
    /// <summary>
    /// Determines whether <paramref name="value"/> is greater than
    /// <paramref name="other"/>.
    /// </summary>
    /// <param name="value">
    /// The provided value to compare.
    ...
    /// <summary>
    /// Determines whether <paramref name="value"/> is less than or equal to
    /// <paramref name="other"/>.
    /// </summary>
    /// <param name="value">
    /// The provided value to compare.
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if <paramref name="value"/> is less than or equal
    /// to <paramref name="other"/>, otherwise <see langword="false"/>.
    /// </returns>
    public static bool LessThanOrEqual(this IComparable value, object other) => value.CompareTo(other) <= 0;
    /// <summary>
    /// Determines whether <paramref name="value"/> is greater than or equal to
    /// <paramref name="other"/>.
    /// </summary>
    /// <param name="value">
    /// The provided value to compare.
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if <paramref name="value"/> is greater than or
    ...
    /// <summary>
    /// Determines whether <paramref name="value"/> is equal to
    /// <paramref name="other"/>.
    /// </summary>
    /// <param name="value">
    /// The provided value to compare.
    ...
    /// <summary>
    /// Determines whether <paramref name="value"/> is not equal to
    /// <paramref name="other"/>.
    /// </summary>
    /// <param name="value">
    /// The provided value to compare.
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if <paramref name="value"/> is not equal to
    /// <paramref name="other"/>, otherwise <see langword="false"/>.
    /// </returns>
    public static bool NotEqualTo(this IComparable value, object other) => value.CompareTo(other) != 0;

    /// <summary>
    /// Determines whether the comparison of <paramref name="value"/> and
    /// <paramref name="other"/> satisfies the given comparison.
    /// </summary>
    /// <param name="value">
    /// The provided value to compare.
    /// </param>
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the comparison of <paramref name="value"/>
    /// with <paramref name="other"/> is satisfied, otherwise
    /// <see langword="false"/>.
    /// </returns>
    ...
    /// <summary>
    /// Determines whether the comparison of <paramref name="value"/> and
    /// <paramref name="other"/> matches the expected result.
    /// </summary>
    /// <param name="value">
    /// The provided value to compare.
    /// </param>
    ...
    /// <returns>
    /// <see langword="true"/> if the comparison of <paramref name="value"/>
    /// with <paramref name="other"/> matches the expected result, otherwise
    /// <see langword="false"/>.
    /// </returns>
    ...
    /// <summary>
    /// Determines the result of the comparison of <paramref name="value"/> with
    /// <paramref name="other"/>.
    /// </summary>
    /// <param name="value">
    /// The provided value to compare.
    ...
    /// </param>
    /// <returns>
    /// A <seealso cref="ComparisonResult"/> representing the result of the
    /// comparison of <paramref name="value"/> with <paramref name="other"/>.
    /// </returns>
    ...
    /// </summary>
    /// <typeparam name="T">
    /// The type of the value that <paramref name="value"/> can be compared
    /// with.
    /// </typeparam>
    /// <param name="value">
    /// The provided value to compare.
    ...
    /// <summary>
    /// Assigns a variable storing a minimum value to <paramref name="other"/>,
    ...
    /// </typeparam>
    /// <param name="min">
    /// A reference to the variable storing the minimum. It may be overwritten
    /// if <paramref name="other"/> is less than the current minimum.
    /// </param>
    /// <param name="other">
    /// The other value to overwrite <paramref name="min"/> with, if found to be
    /// less than it.
    /// </param>
    ...
    /// </typeparam>
    /// <param name="max">
    /// A reference to the variable storing the maximum. It may be overwritten
    /// if <paramref name="other"/> is greater than the current maximum.
    /// </param>
    /// <param name="other">
    /// The other value to overwrite <paramref name="max"/> with, if found to be
    /// greater than it.
    /// </param>
