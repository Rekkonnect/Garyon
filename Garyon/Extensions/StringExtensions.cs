...
public static class StringExtensions
{
    ...
    #region Find
    /// <summary>
    /// Finds a substring within the string. Returns the index of the first
    /// character where the match occurred, otherwise -1.
    /// </summary>
    /// <param name="s">
    ...
    /// <summary>
    /// Finds a substring within the string from the end. Returns the index of
    /// the first character where the match occurred, otherwise -1.
    /// </summary>
    /// <param name="s">
    /// The string within which the search will be performed.
    /// </param>
    ...
    #region IndexOf
    /// <summary>
    /// Gets the index of the first character after the first occurrence of the
    /// given sequence in the original string.
    /// </summary>
    /// <param name="source">
    ...
    /// <paramref name="match"/> in <paramref name="source"/>, if found,
    /// otherwise -1.
    /// </returns>
    ...
    /// The index of the first character to include to the search, from which
    /// onwards the search will be performed.
    /// </param>
    /// <returns>
    /// The index of the first character after the first occurrence of
    /// <paramref name="match"/> in <paramref name="source"/>, if found,
    ...
    /// </param>
    /// <param name="length">
    /// The number of characters that will be searched, starting from the
    ...
    /// Example: <code>RemoveCharacterRepetitions("aabcc") = "abc"</code>
    /// </summary>
    /// <param name="s">
    ...
    /// <summary>
    /// Returns a substring that begins with the beginning matched string and
    /// ends before the ending matched string.
    /// </summary>
    /// <param name="s">
    ...
    /// The new part of the string which will be contained in the returned
    /// string.
    /// </param>
    ...
    /// </param>
    /// <returns>
    /// The given string repeated the specified number of times. If
    /// <paramref name="count"/> is 0, <seealso cref="string.Empty"/> is
    /// returned.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the string is a valid hex string; that is, it
    /// only consists of valid hex characters, otherwise
    /// <see langword="false"/>.
    /// </returns>
    ...
    #region Parsing
    /// <summary>
    /// Parses the <seealso cref="byte"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    ...
    /// </param>
    /// <returns>
    /// The <seealso cref="byte"/> value of the <seealso cref="string"/>.
    /// </returns>
    public static byte ParseByte(this string s) => byte.Parse(s);
    /// <summary>
    /// Parses the <seealso cref="sbyte"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to parse.
    /// </param>
    /// <returns>
    /// The <seealso cref="sbyte"/> value of the <seealso cref="string"/>.
    /// </returns>
    public static sbyte ParseSByte(this string s) => sbyte.Parse(s);
    /// <summary>
    /// Parses the <seealso cref="short"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to parse.
    /// </param>
    /// <returns>
    /// The <seealso cref="short"/> value of the <seealso cref="string"/>.
    /// </returns>
    public static short ParseInt16(this string s) => short.Parse(s);
    /// <summary>
    /// Parses the <seealso cref="ushort"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to parse.
    /// </param>
    /// <returns>
    /// The <seealso cref="ushort"/> value of the <seealso cref="string"/>.
    /// </returns>
    public static ushort ParseUInt16(this string s) => ushort.Parse(s);
    /// <summary>
    /// Parses the <seealso cref="int"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to parse.
    /// </param>
    /// <returns>
    /// The <seealso cref="int"/> value of the <seealso cref="string"/>.
    /// </returns>
    public static int ParseInt32(this string s) => int.Parse(s);
    /// <summary>
    /// Parses the <seealso cref="uint"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to parse.
    /// </param>
    /// <returns>
    /// The <seealso cref="uint"/> value of the <seealso cref="string"/>.
    /// </returns>
    public static uint ParseUInt32(this string s) => uint.Parse(s);
    /// <summary>
    /// Parses the <seealso cref="long"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to parse.
    /// </param>
    /// <returns>
    /// The <seealso cref="long"/> value of the <seealso cref="string"/>.
    /// </returns>
    public static long ParseInt64(this string s) => long.Parse(s);
    /// <summary>
    /// Parses the <seealso cref="ulong"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to parse.
    /// </param>
    /// <returns>
    /// The <seealso cref="ulong"/> value of the <seealso cref="string"/>.
    /// </returns>
    public static ulong ParseUInt64(this string s) => ulong.Parse(s);
    /// <summary>
    /// Parses the <seealso cref="float"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to parse.
    /// </param>
    /// <returns>
    /// The <seealso cref="float"/> value of the <seealso cref="string"/>.
    /// </returns>
    public static float ParseSingle(this string s) => float.Parse(s);
    /// <summary>
    /// Parses the <seealso cref="double"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to parse.
    /// </param>
    /// <returns>
    /// The <seealso cref="double"/> value of the <seealso cref="string"/>.
    /// </returns>
    public static double ParseDouble(this string s) => double.Parse(s);
    /// <summary>
    /// Parses the <seealso cref="decimal"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to parse.
    /// </param>
    /// <returns>
    /// The <seealso cref="decimal"/> value of the <seealso cref="string"/>.
    /// </returns>
    public static decimal ParseDecimal(this string s) => decimal.Parse(s);

    /// <summary>
    /// Tries to parse the <seealso cref="byte"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to try to parse.
    /// </param>
    /// <param name="value">
    /// The <seealso cref="byte"/> value of the <seealso cref="string"/>, if the
    /// parsing was successful, otherwise 0.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the parsing was successful, otherwise
    /// <see langword="false"/>.
    /// </returns>
    public static bool TryParseByte(this string s, out byte value) => byte.TryParse(s, out value);
    /// <summary>
    /// Tries to parse the <seealso cref="sbyte"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to try to parse.
    /// </param>
    /// <param name="value">
    /// The <seealso cref="sbyte"/> value of the <seealso cref="string"/>, if
    /// the parsing was successful, otherwise 0.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the parsing was successful, otherwise
    /// <see langword="false"/>.
    ...
    /// <summary>
    /// Tries to parse the <seealso cref="short"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to try to parse.
    /// </param>
    /// <param name="value">
    /// The <seealso cref="short"/> value of the <seealso cref="string"/>, if
    /// the parsing was successful, otherwise 0.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the parsing was successful, otherwise
    ...
    /// <summary>
    /// Tries to parse the <seealso cref="ushort"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to try to parse.
    /// </param>
    /// <param name="value">
    /// The <seealso cref="ushort"/> value of the <seealso cref="string"/>, if
    /// the parsing was successful, otherwise 0.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the parsing was successful, otherwise
    ...
    /// <summary>
    /// Tries to parse the <seealso cref="int"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to try to parse.
    /// </param>
    /// <param name="value">
    /// The <seealso cref="int"/> value of the <seealso cref="string"/>, if the
    /// parsing was successful, otherwise 0.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the parsing was successful, otherwise
    ...
    /// <summary>
    /// Tries to parse the <seealso cref="uint"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to try to parse.
    /// </param>
    /// <param name="value">
    /// The <seealso cref="uint"/> value of the <seealso cref="string"/>, if the
    /// parsing was successful, otherwise 0.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the parsing was successful, otherwise
    ...
    /// <summary>
    /// Tries to parse the <seealso cref="long"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to try to parse.
    /// </param>
    /// <param name="value">
    /// The <seealso cref="long"/> value of the <seealso cref="string"/>, if the
    /// parsing was successful, otherwise 0.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the parsing was successful, otherwise
    ...
    /// <summary>
    /// Tries to parse the <seealso cref="ulong"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to try to parse.
    /// </param>
    /// <param name="value">
    /// The <seealso cref="ulong"/> value of the <seealso cref="string"/>, if
    /// the parsing was successful, otherwise 0.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the parsing was successful, otherwise
    ...
    /// <summary>
    /// Tries to parse the <seealso cref="float"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to try to parse.
    /// </param>
    /// <param name="value">
    /// The <seealso cref="float"/> value of the <seealso cref="string"/>, if
    /// the parsing was successful, otherwise 0.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the parsing was successful, otherwise
    ...
    /// <summary>
    /// Tries to parse the <seealso cref="double"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to try to parse.
    /// </param>
    /// <param name="value">
    /// The <seealso cref="double"/> value of the <seealso cref="string"/>, if
    /// the parsing was successful, otherwise 0.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the parsing was successful, otherwise
    ...
    /// <summary>
    /// Tries to parse the <seealso cref="decimal"/> value of the specified
    /// <seealso cref="string"/>.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="string"/> to try to parse.
    /// </param>
    /// <param name="value">
    /// The <seealso cref="decimal"/> value of the <seealso cref="string"/>, if
    /// the parsing was successful, otherwise 0.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the parsing was successful, otherwise
    ...
    /// specified prefix, without concatenating it if it is already present.
    /// </summary>
    /// <param name="source">
    ...
    /// </param>
    /// <returns>
    /// The prefix itself if the source string is null or empty, or the source
    /// string if it already starts with the prefix, otherwise a concatenation
    /// of the prefix and the source string.
    /// </returns>
    ...
    /// <summary>
    /// Evaluates a string such that the returned result will end with the
    /// specified suffix, without concatenating it if it is already present.
    /// </summary>
    /// <param name="source">
    ...
    /// </param>
    /// <returns>
    /// The suffix itself if the source string is null or empty, or the source
    /// string if it already ends with the suffix, otherwise a concatenation of
    /// the source string and the suffix.
    /// </returns>
    ...
    /// <summary>
    /// Combines the strings of a string collection with a separator and returns
    /// the new string.
    /// </summary>
    /// <param name="strings">
    ...
    /// </summary>
    /// <remarks>
    /// This complements the lack of the built-in API. If the target framework
    /// adds support for this natively, this method is not defined.
    /// </remarks>
