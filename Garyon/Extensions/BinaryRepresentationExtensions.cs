...
public static unsafe class BinaryRepresentationExtensions
{
    ...
    /// <summary>
    /// Gets the binary representation of the <seealso cref="byte"/> value.
    /// </summary>
    /// <param name="value">
    /// The value.
    /// </param>
    /// <param name="totalBits">
    /// The total bits to display. Defaults to the number of bits a
    /// <seealso cref="byte"/> value contains.
    /// </param>
    /// <returns>
    ...
    /// <summary>
    /// Gets the binary representation of the <seealso cref="sbyte"/> value.
    /// </summary>
    /// <param name="value">
    /// The value.
    /// </param>
    /// <param name="totalBits">
    /// The total bits to display. Defaults to the number of bits a
    /// <seealso cref="sbyte"/> value contains.
    /// </param>
    /// <returns>
    /// The binary representation of the value.
    /// </returns>
    ...
    /// <summary>
    /// Gets the binary representation of the <seealso cref="short"/> value.
    /// </summary>
    /// <param name="value">
    /// The value.
    /// </param>
    /// <param name="totalBits">
    /// The total bits to display. Defaults to the number of bits a
    /// <seealso cref="short"/> value contains.
    /// </param>
    /// <returns>
    /// The binary representation of the value.
    /// </returns>
    ...
    /// <summary>
    /// Gets the binary representation of the <seealso cref="ushort"/> value.
    /// </summary>
    /// <param name="value">
    /// The value.
    /// </param>
    /// <param name="totalBits">
    /// The total bits to display. Defaults to the number of bits a
    /// <seealso cref="ushort"/> value contains.
    /// </param>
    /// <returns>
    /// The binary representation of the value.
    /// </returns>
    ...
    /// <summary>
    /// Gets the binary representation of the <seealso cref="int"/> value.
    /// </summary>
    /// <param name="value">
    /// The value.
    /// </param>
    /// <param name="totalBits">
    /// The total bits to display. Defaults to the number of bits an
    /// <seealso cref="int"/> value contains.
    /// </param>
    /// <returns>
    /// The binary representation of the value.
    /// </returns>
    ...
    /// <summary>
    /// Gets the binary representation of the <seealso cref="uint"/> value.
    /// </summary>
    /// <param name="value">
    /// The value.
    /// </param>
    /// <param name="totalBits">
    /// The total bits to display. Defaults to the number of bits a
    /// <seealso cref="uint"/> value contains.
    /// </param>
    /// <returns>
    /// The binary representation of the value.
    /// </returns>
    ...
    /// <summary>
    /// Gets the binary representation of the <seealso cref="long"/> value.
    /// </summary>
    /// <param name="value">
    /// The value.
    /// </param>
    /// <param name="totalBits">
    /// The total bits to display. Defaults to the number of bits a
    /// <seealso cref="long"/> value contains.
    /// </param>
    /// <returns>
    /// The binary representation of the value.
    /// </returns>
    ...
    /// <summary>
    /// Gets the binary representation of the <seealso cref="ulong"/> value.
    /// </summary>
    /// <param name="value">
    /// The value.
    /// </param>
    /// <param name="totalBits">
    /// The total bits to display. Defaults to the number of bits a
    /// <seealso cref="ulong"/> value contains.
    /// </param>
    /// <returns>
    /// The binary representation of the value.
    /// </returns>
    public static string GetBinaryRepresentation(this ulong value, int totalBits = sizeof(ulong) * 8)
    {
        ...
        for (int i = 0; i < totalBits; i++)
            chars[chars.Length - (i + 1)] = (value & (1UL << i)) > 0 ? '1' : '0';
        return new string(chars);
    }

    /// <summary>
    /// Gets the binary representation of the <seealso cref="byte"/> value,
    /// while also grouping the digits.
    /// </summary>
    /// <param name="value">
    /// The value.
    /// </param>
    /// <param name="groupLength">
    /// The length of each digit group in the resulting binary representation.
    /// Must be non-negative. If 0, no grouping is performed.
    /// </param>
    /// <param name="totalBits">
    /// The total bits to display. Defaults to the number of bits a
    /// <seealso cref="byte"/> value contains.
    ...
    /// <summary>
    /// Gets the binary representation of the <seealso cref="int"/> value, while
    /// also grouping the digits.
    /// </summary>
    /// <param name="value">
    /// The value.
    /// </param>
    ...
    public static string GetGroupedBinaryRepresentation(this ulong value, int groupLength, int totalBits = sizeof(ulong) * 8)
    {
        ...
        for (int i = 0; i < totalBits; i++)
        {
            ...
            if (emptyCharIndex < resultingLength)
                resultingChars[resultingChars.Length -  emptyCharIndex] = ' ';
        }
