...
{
    /// <summary>Provides array casting extensions for five-dimensional arrays.</summary>
    [Autogenerated]
    public static class FiveDimensionalArrayCastingExtensions
    {
        #region Byte[,,,,] -> T[,,,,]
        ...
        public static short[,,,,] CastToInt16Array(this byte[,,,,] a)
        {
            ...
            var result = new short[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4]];
                    ...
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (short)a[i0, i1, i2, i3, i4];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new int[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (int)a[i0, i1, i2, i3, i4];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new long[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (long)a[i0, i1, i2, i3, i4];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new sbyte[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (sbyte)a[i0, i1, i2, i3, i4];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new ushort[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (ushort)a[i0, i1, i2, i3, i4];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new uint[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (uint)a[i0, i1, i2, i3, i4];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new ulong[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (ulong)a[i0, i1, i2, i3, i4];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new float[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (float)a[i0, i1, i2, i3, i4];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new double[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (double)a[i0, i1, i2, i3, i4];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new decimal[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (decimal)a[i0, i1, i2, i3, i4];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new char[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (char)a[i0, i1, i2, i3, i4];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new bool[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = a[i0, i1, i2, i3, i4] != 0;
            return result;
        }
        #endregion
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new byte[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (byte)a[i0, i1, i2, i3, i4];
            return result;
        }
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (byte)(a[i0, i1, i2, i3, i4] ? 1 : 0);
            return result;
        }
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (short)(a[i0, i1, i2, i3, i4] ? 1 : 0);
            return result;
        }
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (int)(a[i0, i1, i2, i3, i4] ? 1 : 0);
            return result;
        }
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (long)(a[i0, i1, i2, i3, i4] ? 1 : 0);
            return result;
        }
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (sbyte)(a[i0, i1, i2, i3, i4] ? 1 : 0);
            return result;
        }
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (ushort)(a[i0, i1, i2, i3, i4] ? 1 : 0);
            return result;
        }
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (uint)(a[i0, i1, i2, i3, i4] ? 1 : 0);
            return result;
        }
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (ulong)(a[i0, i1, i2, i3, i4] ? 1 : 0);
            return result;
        }
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (float)(a[i0, i1, i2, i3, i4] ? 1 : 0);
            return result;
        }
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (double)(a[i0, i1, i2, i3, i4] ? 1 : 0);
            return result;
        }
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (decimal)(a[i0, i1, i2, i3, i4] ? 1 : 0);
            return result;
        }
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                result[i0, i1, i2, i3, i4] = (char)(a[i0, i1, i2, i3, i4] ? 1 : 0);
            return result;
        }
        #endregion
    }
