...
{
    /// <summary>Provides array casting extensions for three-dimensional arrays.</summary>
    [Autogenerated]
    public static class ThreeDimensionalArrayCastingExtensions
    {
        #region Byte[,,] -> T[,,]
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new int[lengths[0], lengths[1], lengths[2]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (int)a[i0, i1, i2];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new long[lengths[0], lengths[1], lengths[2]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (long)a[i0, i1, i2];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new sbyte[lengths[0], lengths[1], lengths[2]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (sbyte)a[i0, i1, i2];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new ushort[lengths[0], lengths[1], lengths[2]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (ushort)a[i0, i1, i2];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new uint[lengths[0], lengths[1], lengths[2]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (uint)a[i0, i1, i2];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new ulong[lengths[0], lengths[1], lengths[2]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (ulong)a[i0, i1, i2];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new float[lengths[0], lengths[1], lengths[2]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (float)a[i0, i1, i2];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new double[lengths[0], lengths[1], lengths[2]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (double)a[i0, i1, i2];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new decimal[lengths[0], lengths[1], lengths[2]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (decimal)a[i0, i1, i2];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new char[lengths[0], lengths[1], lengths[2]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (char)a[i0, i1, i2];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new bool[lengths[0], lengths[1], lengths[2]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = a[i0, i1, i2] != 0;
            return result;
        }
        #endregion
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new byte[lengths[0], lengths[1], lengths[2]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (byte)a[i0, i1, i2];
            return result;
        }
        ...
        public static byte[,,] CastToByteArray(this bool[,,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (byte)(a[i0, i1, i2] ? 1 : 0);
            return result;
        }
        ...
        public static short[,,] CastToInt16Array(this bool[,,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (short)(a[i0, i1, i2] ? 1 : 0);
            return result;
        }
        ...
        public static int[,,] CastToInt32Array(this bool[,,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (int)(a[i0, i1, i2] ? 1 : 0);
            return result;
        }
        ...
        public static long[,,] CastToInt64Array(this bool[,,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (long)(a[i0, i1, i2] ? 1 : 0);
            return result;
        }
        ...
        public static sbyte[,,] CastToSByteArray(this bool[,,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (sbyte)(a[i0, i1, i2] ? 1 : 0);
            return result;
        }
        ...
        public static ushort[,,] CastToUInt16Array(this bool[,,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (ushort)(a[i0, i1, i2] ? 1 : 0);
            return result;
        }
        ...
        public static uint[,,] CastToUInt32Array(this bool[,,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (uint)(a[i0, i1, i2] ? 1 : 0);
            return result;
        }
        ...
        public static ulong[,,] CastToUInt64Array(this bool[,,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (ulong)(a[i0, i1, i2] ? 1 : 0);
            return result;
        }
        ...
        public static float[,,] CastToSingleArray(this bool[,,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (float)(a[i0, i1, i2] ? 1 : 0);
            return result;
        }
        ...
        public static double[,,] CastToDoubleArray(this bool[,,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (double)(a[i0, i1, i2] ? 1 : 0);
            return result;
        }
        ...
        public static decimal[,,] CastToDecimalArray(this bool[,,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (decimal)(a[i0, i1, i2] ? 1 : 0);
            return result;
        }
        ...
        public static char[,,] CastToCharArray(this bool[,,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        result[i0, i1, i2] = (char)(a[i0, i1, i2] ? 1 : 0);
            return result;
        }
        #endregion
    }
