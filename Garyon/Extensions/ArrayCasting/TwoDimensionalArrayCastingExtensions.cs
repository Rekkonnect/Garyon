...
{
    /// <summary>Provides array casting extensions for two-dimensional arrays.</summary>
    [Autogenerated]
    public static class TwoDimensionalArrayCastingExtensions
    {
        #region Byte[,] -> T[,]
        ...
        public static short[,] CastToInt16Array(this byte[,] a)
        {
            ...
            var result = new short[lengths[0], lengths[1]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (short)a[i0, i1];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new int[lengths[0], lengths[1]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (int)a[i0, i1];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new long[lengths[0], lengths[1]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (long)a[i0, i1];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new sbyte[lengths[0], lengths[1]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (sbyte)a[i0, i1];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new ushort[lengths[0], lengths[1]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (ushort)a[i0, i1];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new uint[lengths[0], lengths[1]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (uint)a[i0, i1];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new ulong[lengths[0], lengths[1]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (ulong)a[i0, i1];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new float[lengths[0], lengths[1]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (float)a[i0, i1];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new double[lengths[0], lengths[1]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (double)a[i0, i1];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new decimal[lengths[0], lengths[1]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (decimal)a[i0, i1];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new char[lengths[0], lengths[1]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (char)a[i0, i1];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new bool[lengths[0], lengths[1]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = a[i0, i1] != 0;
            return result;
        }
        #endregion
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new byte[lengths[0], lengths[1]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (byte)a[i0, i1];
            return result;
        }
        ...
        public static short[,] CastToInt16Array(this bool[,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (short)(a[i0, i1] ? 1 : 0);
            return result;
        }
        ...
        public static sbyte[,] CastToSByteArray(this bool[,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (sbyte)(a[i0, i1] ? 1 : 0);
            return result;
        }
        ...
        public static ushort[,] CastToUInt16Array(this bool[,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (ushort)(a[i0, i1] ? 1 : 0);
            return result;
        }
        ...
        public static ulong[,] CastToUInt64Array(this bool[,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (ulong)(a[i0, i1] ? 1 : 0);
            return result;
        }
        ...
        public static float[,] CastToSingleArray(this bool[,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (float)(a[i0, i1] ? 1 : 0);
            return result;
        }
        ...
        public static double[,] CastToDoubleArray(this bool[,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (double)(a[i0, i1] ? 1 : 0);
            return result;
        }
        ...
        public static decimal[,] CastToDecimalArray(this bool[,] a)
        {
            ...
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    result[i0, i1] = (decimal)(a[i0, i1] ? 1 : 0);
            return result;
        }
