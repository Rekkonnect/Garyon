...
{
    /// <summary>Provides array casting extensions for six-dimensional arrays.</summary>
    [Autogenerated]
    public static class SixDimensionalArrayCastingExtensions
    {
        #region Byte[,,,,,] -> T[,,,,,]
        ...
        public static short[,,,,,] CastToInt16Array(this byte[,,,,,] a)
        {
            ...
            var result = new short[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4], lengths[5]];
                        ...
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (short)a[i0, i1, i2, i3, i4, i5];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new int[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4], lengths[5]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (int)a[i0, i1, i2, i3, i4, i5];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new long[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4], lengths[5]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (long)a[i0, i1, i2, i3, i4, i5];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new sbyte[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4], lengths[5]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (sbyte)a[i0, i1, i2, i3, i4, i5];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new ushort[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4], lengths[5]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (ushort)a[i0, i1, i2, i3, i4, i5];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new uint[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4], lengths[5]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (uint)a[i0, i1, i2, i3, i4, i5];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new ulong[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4], lengths[5]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (ulong)a[i0, i1, i2, i3, i4, i5];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new float[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4], lengths[5]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (float)a[i0, i1, i2, i3, i4, i5];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new double[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4], lengths[5]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (double)a[i0, i1, i2, i3, i4, i5];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new decimal[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4], lengths[5]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (decimal)a[i0, i1, i2, i3, i4, i5];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new char[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4], lengths[5]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (char)a[i0, i1, i2, i3, i4, i5];
            return result;
        }
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new bool[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4], lengths[5]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = a[i0, i1, i2, i3, i4, i5] != 0;
            return result;
        }
        #endregion
        ...
        {
            var lengths = a.GetDimensionLengths();
            var result = new byte[lengths[0], lengths[1], lengths[2], lengths[3], lengths[4], lengths[5]];
            for (int i0 = 0; i0 < lengths[0]; i0++)
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (byte)a[i0, i1, i2, i3, i4, i5];
            return result;
        }
                ...
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (byte)(a[i0, i1, i2, i3, i4, i5] ? 1 : 0);
            return result;
        }
                ...
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (short)(a[i0, i1, i2, i3, i4, i5] ? 1 : 0);
            return result;
        }
                ...
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (int)(a[i0, i1, i2, i3, i4, i5] ? 1 : 0);
            return result;
        }
                ...
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (long)(a[i0, i1, i2, i3, i4, i5] ? 1 : 0);
            return result;
        }
                ...
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (sbyte)(a[i0, i1, i2, i3, i4, i5] ? 1 : 0);
            return result;
        }
                ...
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (ushort)(a[i0, i1, i2, i3, i4, i5] ? 1 : 0);
            return result;
        }
                ...
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (uint)(a[i0, i1, i2, i3, i4, i5] ? 1 : 0);
            return result;
        }
                ...
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (ulong)(a[i0, i1, i2, i3, i4, i5] ? 1 : 0);
            return result;
        }
                ...
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (float)(a[i0, i1, i2, i3, i4, i5] ? 1 : 0);
            return result;
        }
                ...
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (double)(a[i0, i1, i2, i3, i4, i5] ? 1 : 0);
            return result;
        }
                ...
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (decimal)(a[i0, i1, i2, i3, i4, i5] ? 1 : 0);
            return result;
        }
                ...
                for (int i1 = 0; i1 < lengths[1]; i1++)
                    for (int i2 = 0; i2 < lengths[2]; i2++)
                        for (int i3 = 0; i3 < lengths[3]; i3++)
                            for (int i4 = 0; i4 < lengths[4]; i4++)
                                for (int i5 = 0; i5 < lengths[5]; i5++)
                                    result[i0, i1, i2, i3, i4, i5] = (char)(a[i0, i1, i2, i3, i4, i5] ? 1 : 0);
            return result;
        }
        #endregion
    }
