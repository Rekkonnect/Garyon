...
/// </summary>
/// <remarks>
/// Most extensions operate on the enumerator by reference, thus propagating
/// mutations to the original instance.
/// </remarks>
public static class SpanLineEnumeratorExtensions
{
    extension(ref SpanLineEnumerator enumerator)
    {
        ...
        /// </summary>
        /// <returns>
        /// <see langword="true"/> if a non-empty line was found; otherwise,
        /// <see langword="false"/>.
        /// </returns>
        ...
        /// <summary>
        /// Consumes the next line in the enumerator, by advancing it and
        /// returning the line.
        /// </summary>
        /// <param name="line">
