...
/// <summary>
/// Provides extensions for the <seealso cref="Stack{T}"/> class.
/// </summary>
public static class StackExtensions
{
    ...
    /// </param>
    /// <remarks>
    /// This is an expensive operation, due to the lack of the necessary public
    /// APIs for speeding up the insertion.
    /// </remarks>
