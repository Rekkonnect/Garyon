...
/// <summary>
/// Provides extension methods for the <seealso cref="StringBuilder"/> class.
/// </summary>
public static class StringBuilderExtensions
{
    ...
    /// </param>
    /// <returns>
    /// The same <seealso cref="StringBuilder"/> instance.
    /// </returns>
    ...
    /// <summary>
    /// Appends an object's string representation, and appends a new line after
    /// that.
    /// </summary>
    /// <param name="builder">
    /// The <seealso cref="StringBuilder"/> instance on which to append.
    ...
    /// <summary>
    /// Appends the string representations of objects in a collection, and
    /// appends a new line after that.
    /// </summary>
    /// <param name="builder">
    /// The <seealso cref="StringBuilder"/> instance on which to append.
    /// </param>
    ...
    /// <summary>
    /// Copies this <seealso cref="StringBuilder"/> into a new instance.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="StringBuilder"/> to copy.
    /// </param>
    /// <returns>
    /// The new copied <seealso cref="StringBuilder"/> instance.
    /// </returns>
    /// <remarks>
    /// In .NET Core 3.1 onwards, this uses the GetChunks method that enumerates
    /// the chunks contained in the builder, whereas for the earlier versions of
    /// the framework the builder is converted into the full string, and the new
    /// instance is initialized through that.
    /// </remarks>
    ...
    /// <summary>
    /// Removes a range of characters from the specified starting index to the
    /// end of the string.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="StringBuilder"/> whose range of characters to remove.
    /// </param>
    ...
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="StringBuilder"/> whose last characters to remove.
    /// </param>
    ...
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="StringBuilder"/> whose last character to remove.
    /// </param>
    public static StringBuilder RemoveLast(this StringBuilder s) => s.RemoveLast(1);
    /// <summary>
    /// Removes the last character of the string if it has any characters,
    /// otherwise none.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="StringBuilder"/> whose last character to remove, if
    /// any.
    /// </param>
    public static StringBuilder RemoveLastOrNone(this StringBuilder s) => s.RemoveLast(s.Length > 0 ? 1 : 0);
    /// <summary>
    /// Removes the last character of the string if it ends with the requested
    ...
    /// The character that should be the last character of the string to remove
    /// the last character.
    /// </param>
    ...
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="StringBuilder"/> whose last character to retrieve.
    /// </param>
    public static char Last(this StringBuilder s) => s[s.Length - 1];
    /// <summary>
    /// Retrieves the last character of the string if the string has any
    /// characters, otherwise returns <see langword="null"/> if the
    /// <seealso cref="StringBuilder"/> is <see langword="null"/> or if it has
    /// no characters.
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="StringBuilder"/> whose last character to retrieve.
    ...
    /// </summary>
    /// <param name="s">
    /// The <seealso cref="StringBuilder"/> to check whether it ends with the
    /// specified character.
    /// </param>
    /// <param name="lastCharacter">
    ...
    /// <summary>
    /// Removes the all leading whitespace characters from the current
    /// <see cref="StringBuilder"/>.
    /// </summary>
    /// <param name="s">
    /// The <see cref="StringBuilder"/> from which to remove all leading
    /// whitespace characters.
    /// </param>
    /// <returns>
    /// The original <see cref="StringBuilder"/> instance.
    /// </returns>
    ...
    /// <summary>
    /// Appends a string to the <seealso cref="StringBuilder"/> instance, from
    /// its start index up until its end.
    /// </summary>
    /// <param name="stringBuilder">
    /// The <seealso cref="StringBuilder"/> instance on which to append the
    /// string.
    /// </param>
    /// <param name="value">
    /// The string to append to the <seealso cref="StringBuilder"/> from the
    /// specified index onwards.
    /// </param>
    /// <param name="startIndex">
    /// The index of the first character to append to the
    /// <seealso cref="StringBuilder"/>.
    /// </param>
    /// <returns>
    /// The <seealso cref="StringBuilder"/> instance that the string was
    /// appended to.
    /// </returns>
    ...
    /// </summary>
    /// <param name="builder">
    /// The original <seealso cref="StringBuilder"/>.
    /// </param>
