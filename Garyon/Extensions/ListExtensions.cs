...
/// <summary>
/// Provides extension methods for the <seealso cref="List{T}"/> class.
/// </summary>
public static class ListExtensions
{
    ...
    #region Operations
    /// <summary>
    /// Removes a collection of elements from a list and returns a new list that
    /// does not contain the removed elements.
    /// </summary>
    /// <typeparam name="T">
    ...
    /// <summary>
    /// Inserts an element at the start of the <seealso cref="List{T}"/>.
    /// </summary>
    /// <typeparam name="T">
    /// The type of the elements contained in the <seealso cref="List{T}"/>.
    /// </typeparam>
    /// <param name="l">
    /// The <seealso cref="List{T}"/> at whose start to insert the element.
    /// </param>
    /// <param name="element">
    /// The element to add.
    /// </param>
    /// <returns>
    /// The instance of the <seealso cref="List{T}"/> in which the new element
    /// was inserted.
    /// </returns>
    ...
    /// <summary>
    /// Moves an element in the <seealso cref="List{T}"/> to a different
    /// position.
    /// </summary>
    /// <typeparam name="T">
    /// The type of the elements contained in the <seealso cref="List{T}"/>.
    /// </typeparam>
    /// <param name="l">
    /// The <seealso cref="List{T}"/> within which to move an element.
    /// </param>
    /// <param name="from">
    ...
    /// </param>
    /// <returns>
    /// The instance of the <seealso cref="List{T}"/> in which the element was
    /// moved.
    /// </returns>
    ...
    /// <summary>
    /// Moves an element to the end of the <seealso cref="List{T}"/>.
    /// </summary>
    /// <typeparam name="T">
    /// The type of the elements contained in the <seealso cref="List{T}"/>.
    /// </typeparam>
    ...
    /// <summary>
    /// Moves an element to the start of the <seealso cref="List{T}"/>.
    /// </summary>
    /// <typeparam name="T">
    /// The type of the elements contained in the <seealso cref="List{T}"/>.
    /// </typeparam>
    ...
    /// <summary>
    /// Sets an element to the list at the specified index, by extending the
    /// list if the count is insufficient.
    /// </summary>
    /// <typeparam name="T">
    /// The element type.
    /// </typeparam>
