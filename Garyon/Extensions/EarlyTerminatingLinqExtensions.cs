...
public static partial class EarlyTerminatingLinqExtensions
{
    ...
    /// <summary>
    /// Determines whether the sum of a collection of values is strictly less
    /// than the target.
    /// </summary>
    /// <returns>
    /// <see langword="true"/> if the sum is strictly less than (&lt;) the
    ...
    /// <inheritdoc cref="SumSatisfiesDocTemplate"/>
    /// <summary>
    /// Determines whether the sum of a collection of values is at most equal to
    /// the target.
    /// </summary>
    /// <returns>
    /// <see langword="true"/> if the sum is less than or equal to (&lt;=) the
    /// target, otherwise <see langword="false"/>.
    /// </returns>
    ...
    /// <inheritdoc cref="SumSatisfiesDocTemplate"/>
    /// <summary>
    /// Determines whether the sum of a collection of values is strictly greater
    /// than the target.
    /// </summary>
    /// <returns>
    /// <see langword="true"/> if the sum is strictly greater than (&gt;) the
    /// target, otherwise <see langword="false"/>.
    /// </returns>
    public static bool SumsOver(this IEnumerable<uint> values, uint target) => SumSatisfies(values, ComparisonKinds.Greater, target);
    /// <inheritdoc cref="SumSatisfiesDocTemplate"/>
    /// <summary>
    /// Determines whether the sum of a collection of values is at least equal
    /// to the target.
    /// </summary>
    /// <returns>
    /// <see langword="true"/> if the sum is greater than or equal to (&gt;=)
    /// the target, otherwise <see langword="false"/>.
    /// </returns>
    ...
    /// <inheritdoc cref="SumSatisfiesDocTemplate"/>
    /// <summary>
    /// Determines whether the sum of a collection of values satisfies a
    /// comparison against the target value.
    /// </summary>
    /// <param name="comparisonKinds">
    /// The comparison kinds that must be satisfied.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the sum satisfies the given comparison,
    ...
    /// <summary>
    /// Enumerates a collection, but halts enumeration as soon as a value that
    /// satisfies the given predicate is found.
    /// </summary>
    /// <typeparam name="T">
    /// The type of the values the collection contains.
    /// </typeparam>
    /// <param name="source">
    /// The collection whose values to enumerate and evaluate through
    /// <paramref name="predicate"/>.
    /// </param>
    /// <param name="predicate">
    /// The predicate which will cause enumeration to halt upon being satisfied.
    /// </param>
    /// <param name="includeHaltingValue">
    /// Determines whether the final value that causes enumeration to halt
    /// should be retuned or not.
    /// </param>
    /// <returns>
    /// The first elements that do not satisfy <paramref name="predicate"/>,
    /// and, optionally, the first value that satisfies it.
    /// </returns>
