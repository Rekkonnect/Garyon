...
{
    // Documentation for records is currently a mess
    ...
    {
        /// <summary>Gets a new instance of the <seealso cref="MinMaxResult{T}"/> struct with both values being <see langword="default"/>.</summary>
