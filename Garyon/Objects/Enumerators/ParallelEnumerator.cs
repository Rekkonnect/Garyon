...
/// <summary>
/// Provides a mechanism for parallelly enumerating 2
...
{
    /// <summary>
    /// Gets a tuple containing the current values of both enumerators. If any
    /// enumerator is beyond the end of the collection, the respective value is
    /// equal to <see langword="default"/>.
    /// </summary>
    ...
    /// <seealso cref="ParallelEnumerator{T1, T2}"/> class from 2
    /// <seealso cref="IEnumerable{T}"/> objects.
    /// </summary>
...
/// <summary>
/// Provides a mechanism for parallelly enumerating 3
/// <seealso cref="IEnumerable{T}"/> objects.
/// </summary>
public sealed class ParallelEnumerator<T1, T2, T3> : BaseParallelEnumerator<T1, T2, T3>, IEnumerator<(T1?, T2?, T3?)>
{
    /// <summary>
    /// Gets a tuple containing the current values of all enumerators. If any
    /// enumerator is beyond the end of the collection, the respective value is
    /// equal to <see langword="default"/>.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the
    /// <seealso cref="ParallelEnumerator{T1, T2, T3}"/> class from 3
    /// <seealso cref="IEnumerable{T}"/> objects.
    /// </summary>
    /// <param name="enumerable1">
    /// The first enumerable.
...
/// <summary>
/// Provides a mechanism for parallelly enumerating 4
/// <seealso cref="IEnumerable{T}"/> objects.
/// </summary>
public sealed class ParallelEnumerator<T1, T2, T3, T4> : BaseParallelEnumerator<T1, T2, T3, T4>, IEnumerator<(T1?, T2?, T3?, T4?)>
{
    ...
    /// <summary>
    /// Initializes a new instance of the
    /// <seealso cref="ParallelEnumerator{T1, T2, T3}"/> class from 4
    /// <seealso cref="IEnumerable{T}"/> objects.
    /// </summary>
    /// <param name="enumerable1">
    /// The first enumerable.
