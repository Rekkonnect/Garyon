...
/// <summary>
/// Provides the base mechanism for a parallel enumerator for 2
...
public abstract class BaseParallelEnumerator<T1, T2> : BaseParallelEnumerator
{
    ...
    /// <summary>
    /// Determines whether the first enumerator has not reached the end of the
    /// collection.
    /// </summary>
    public bool Enumerator1Alive => enumerator1Alive;
    /// <summary>
    /// Determines whether the second enumerator has not reached the end of the
    /// collection.
    /// </summary>
    ...
    /// <seealso cref="BaseParallelEnumerator{T1, T2}"/> class.
    /// </summary>
    ...
    /// </summary>
    /// <returns>
    /// <see langword="true"/> if any of the two enumerators was successfully
    /// advanced to the next element; <see langword="false"/> if both
    /// enumerators have passed the end of the collection.
    /// </returns>
    ...
    /// <summary>
    /// Sets both enumerators to their initial position, which is before the
    ...
    /// <summary>
    /// Calls the <seealso cref="IDisposable.Dispose()"/> method on both
    /// enumerators.
    /// </summary>
