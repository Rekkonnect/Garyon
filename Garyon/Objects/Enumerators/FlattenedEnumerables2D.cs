    ...
    : IEnumerable<T>
{
    ...
    /// <seealso cref="FlattenedEnumerables2D{T}"/> class.
    /// </summary>
    internal class Enumerator : IEnumerator<T>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <seealso cref="Enumerator"/> class
        /// out of a <seealso cref="FlattenedEnumerables2D{T}"/> instance.
        /// </summary>
        /// <param name="instance">
        /// The <seealso cref="FlattenedEnumerables2D{T}"/> whose enumerables
        /// will be flattened.
        /// </param>
        ...
        /// <summary>
        /// Initializes a new instance of the <seealso cref="Enumerator"/> class
        /// out of an enumerator of collections.
        /// </summary>
        /// <param name="enumerator">
        /// The enumerator that will enumerate the collections of the elements
        /// that will be flattened. It should not have any other dependencies.
        /// See <seealso cref="Dispose"/> for more info.
        /// </param>
