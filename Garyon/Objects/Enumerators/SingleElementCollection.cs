...
/// <summary>
/// Represents a <seealso cref="IReadOnlyCollection{T}"/> that contains a single
/// element.
/// </summary>
/// <typeparam name="T">
...
public readonly struct SingleElementCollection<T> : IReadOnlyCollection<T?>, IEquatable<SingleElementCollection<T?>>
{
    ...
    /// <seealso cref="SingleElementCollection{T}"/> struct, out of the single
    /// element that will be contained in the collection.
    /// </summary>
    /// <param name="singleElement">
    /// The single element that will be contained in the collection. It may be
    /// <see langword="null"/>.
    /// </param>
    ...
    /// <summary>
    /// Initializes a new instance of the
    /// <seealso cref="SingleElementCollection{T}"/> struct, out of another
    /// <see cref="SingleElementCollection{T}"/>.
    /// </summary>
    /// <param name="other">
    /// The other <seealso cref="SingleElementCollection{T}"/> out of which to
    /// initialize this new collection.
    /// </param>
    ...
    /// <summary>
    /// Constructs a new <seealso cref="SingleElementCollection{T}"/> that
    /// contains the provided element.
    /// </summary>
    /// <param name="newElement">
    /// The new element that will be contained.
    /// </param>
    /// <returns>
    /// A new <seealso cref="SingleElementCollection{T}"/> containing the
    /// provided element.
    /// </returns>
    ...
    /// <summary>
    /// Gets the hash code of the current collection, which is determined by its
    /// only contained element.
    /// </summary>
    /// <returns>
    /// The hash code of its only contained element, if not
    /// <see langword="null"/>, otherwise <see langword="default"/>.
    /// </returns>
