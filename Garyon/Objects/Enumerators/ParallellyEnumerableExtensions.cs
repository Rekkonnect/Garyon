...
{
    /// <summary>
    /// Creates an instance of <seealso cref="ParallellyEnumerable{T1, T2}"/>
    /// out of a tuple of 2 collections.
    /// </summary>
    /// <typeparam name="T1">
    /// The type of the elements stored in the first collection.
    /// </typeparam>
    /// <typeparam name="T2">
    /// The type of the elements stored in the second collection.
    /// </typeparam>
    /// <param name="enumerables">
    /// The tuple of 2 enumerables that will be parallelly enumerated.
    /// </param>
    /// <returns>
    /// The instance of <seealso cref="ParallellyEnumerable{T1, T2}"/> that will
    /// parallelly enumerate the 2 collections.
    /// </returns>
    ...
    /// </typeparam>
    /// <typeparam name="T3">
    /// The type of the elements stored in the third collection.
    /// </typeparam>
    /// <param name="enumerables">
    /// The tuple of 3 enumerables that will be parallelly enumerated.
    /// </param>
    /// <returns>
    /// The instance of <seealso cref="ParallellyEnumerable{T1, T2, T3}"/> that
    /// will parallelly enumerate the 3 collections.
    /// </returns>
    ...
    /// </typeparam>
    /// <typeparam name="T4">
    /// The type of the elements stored in the fourth collection.
    /// </typeparam>
    /// <param name="enumerables">
    /// The tuple of 4 enumerables that will be parallelly enumerated.
    /// </param>
    /// <returns>
    /// The instance of <seealso cref="ParallellyEnumerable{T1, T2, T3, T4}"/>
    /// that will parallelly enumerate the 4 collections.
    /// </returns>
