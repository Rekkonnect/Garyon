...
/// <summary>
/// Provides a better alternative for the <seealso cref="Random"/> class,
/// offering further functionality.
/// </summary>
public class AdvancedRandom : Random
{
    /// <summary>
    /// Generates a random <seealso cref="byte"/> within the range [0,
    /// <seealso cref="byte.MaxValue"/>].
    /// </summary>
    /// <returns>
    /// The resulting <seealso cref="byte"/>.
    /// </returns>
    ...
    /// </summary>
    /// <param name="maxValue">
    /// The exclusive upper bound of the random number returned. Must be greater
    /// than 0.
    /// </param>
    /// <returns>
    /// The resulting <seealso cref="byte"/>.
    ...
    /// <summary>
    /// Generates a random <seealso cref="byte"/> within the range
    ...
    /// <summary>
    /// Generates a random <seealso cref="short"/> within the range [0,
    /// <seealso cref="short.MaxValue"/>].
    /// </summary>
    /// <returns>
    /// The resulting <seealso cref="short"/>.
    /// </returns>
    ...
    /// <summary>
    /// Generates a random <seealso cref="short"/> within the range
    /// [<paramref name="minValue"/>, <paramref name="maxValue"/>).
    /// </summary>
    /// <param name="minValue">
    /// The inclusive lower bound of the random number returned.
    ...
    /// <summary>
    /// Generates a random <seealso cref="long"/> within the range [0,
    /// <seealso cref="long.MaxValue"/>]. May use up to 2 number generations due
    /// to <seealso cref="double"/>'s lesser precision.
    /// </summary>
    /// <returns>
    /// The resulting <seealso cref="long"/>.
    /// </returns>
    public virtual long NextInt64() => ExtendSample((long)Sample(long.MaxValue));
    /// <summary>
    /// Generates a random <seealso cref="long"/> within the range [0,
    /// <paramref name="maxValue"/>). May use up to 2 number generations due to
    /// <seealso cref="double"/>'s lesser precision.
    /// </summary>
    /// <param name="maxValue">
    /// The exclusive upper bound of the random number returned. Must be greater
    /// than 0.
    ...
    /// <summary>
    /// Generates a random <seealso cref="long"/> within the range
    /// [<paramref name="minValue"/>, <paramref name="maxValue"/>). May use up
    /// to 2 number generations due to <seealso cref="double"/>'s lesser
    /// precision.
    /// </summary>
    /// <param name="minValue">
    /// The inclusive lower bound of the random number returned.
    ...
    /// <summary>
    /// Generates a random <seealso cref="sbyte"/> within the range [0,
    /// <seealso cref="sbyte.MaxValue"/>].
    /// </summary>
    /// <returns>
    /// The resulting <seealso cref="sbyte"/>.
    /// </returns>
    ...
    /// <summary>
    /// Generates a random <seealso cref="sbyte"/> within the range
    /// [<paramref name="minValue"/>, <paramref name="maxValue"/>).
    /// </summary>
    /// <param name="minValue">
    /// The inclusive lower bound of the random number returned.
    ...
    /// <summary>
    /// Generates a random <seealso cref="ushort"/> within the range [0,
    /// <seealso cref="ushort.MaxValue"/>].
    /// </summary>
    /// <returns>
    /// The resulting <seealso cref="ushort"/>.
    /// </returns>
    ...
    /// <summary>
    /// Generates a random <seealso cref="ushort"/> within the range
    /// [<paramref name="minValue"/>, <paramref name="maxValue"/>).
    /// </summary>
    /// <param name="minValue">
    /// The inclusive lower bound of the random number returned.
    ...
    /// <summary>
    /// Generates a random <seealso cref="uint"/> within the range [0,
    /// <seealso cref="uint.MaxValue"/>].
    /// </summary>
    /// <returns>
    /// The resulting <seealso cref="uint"/>.
    /// </returns>
    ...
    /// <summary>
    /// Generates a random <seealso cref="uint"/> within the range
    /// [<paramref name="minValue"/>, <paramref name="maxValue"/>).
    /// </summary>
    /// <param name="minValue">
    /// The inclusive lower bound of the random number returned.
    ...
    /// <summary>
    /// Generates a random <seealso cref="ulong"/> within the range [0,
    /// <seealso cref="ulong.MaxValue"/>]. May use up to 2 number generations
    /// due to <seealso cref="double"/>'s lesser precision.
    /// </summary>
    /// <returns>
    /// The resulting <seealso cref="ulong"/>.
    /// </returns>
    ...
    /// <summary>
    /// Generates a random <seealso cref="ulong"/> within the range
    /// [<paramref name="minValue"/>, <paramref name="maxValue"/>). May use up
    /// to 2 number generations due to <seealso cref="double"/>'s lesser
    /// precision.
    /// </summary>
...
#if !HAS_RANDOM_NEXTINT64_NEXTSINGLE
    /// <summary>
    /// Generates a random <seealso cref="float"/> within the range [0, 1).
    /// </summary>
    /// <returns>
    /// The resulting <seealso cref="float"/>.
    /// </returns>
    public virtual float NextSingle() => (float)Sample();
#endif
    /// <summary>
    /// Generates a random <seealso cref="float"/> within the range [0,
    /// <paramref name="maxValue"/>).
    /// </summary>
    /// <param name="maxValue">
    /// The exclusive upper bound of the random number returned. Must be greater
    ...
    /// <summary>
    /// Generates a random <seealso cref="float"/> within the range
    /// [<paramref name="minValue"/>, <paramref name="maxValue"/>).
    /// </summary>
    /// <param name="minValue">
    /// The inclusive lower bound of the random number returned.
    ...
    /// <summary>
    /// Generates a random <seealso cref="double"/> within the range [0,
    /// <paramref name="maxValue"/>).
    /// </summary>
    /// <param name="maxValue">
    /// The exclusive upper bound of the random number returned. Must be greater
    ...
    /// </param>
    /// <returns>
    /// The resulting <seealso cref="double"/>.
    /// </returns>
    public virtual double NextDouble(double maxValue) => Sample(maxValue);
    /// <summary>
    /// Generates a random <seealso cref="double"/> within the range
    /// [<paramref name="minValue"/>, <paramref name="maxValue"/>).
    /// </summary>
    /// <param name="minValue">
    /// The inclusive lower bound of the random number returned.
    ...
    /// <summary>
    /// Generates a random <seealso cref="char"/> within the range [0,
    /// <seealso cref="char.MaxValue"/>].
    /// </summary>
    /// <returns>
    /// The resulting <seealso cref="char"/>.
    /// </returns>
    ...
    /// <summary>
    /// Generates a random <seealso cref="char"/> within the range
    /// [<paramref name="minValue"/>, <paramref name="maxValue"/>).
    /// </summary>
    /// <param name="minValue">
    /// The inclusive lower bound of the random number returned.
    ...
    /// <summary>
    /// Generates a random <seealso cref="bool"/>.
    /// </summary>
    /// <returns>
    /// The resulting <seealso cref="bool"/>.
    /// </returns>
    public virtual bool NextBoolean() => Sample() >= 0.5;

    /// <summary>
    /// Initializes a new instance of the <seealso cref="AdvancedRandom"/>
    ...
    /// <param name="seed">
    /// A number used to calculate a starting value for the pseudo-random number
    /// sequence. If a negative number is specified, the absolute value of the
    /// number is used.
    /// </param>
    ...
    /// </summary>
    /// <param name="seed">
    /// A number, whose hash code will be used to calculate a starting value for
    ...
    /// </summary>
    /// <param name="seed">
    /// A floating-point number, whose bit reinterpretation as an
    /// <seealso cref="int"/> will be used to calculate a starting value for the
