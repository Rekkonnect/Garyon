...
{
    /// <summary>
    /// Represents the default value of the enum. It should only be used in
    /// argument validation.
    /// </summary>
    None = 0,
    ...
    /// </summary>
    /// <remarks>
    /// The value is identical to <seealso cref="NotEqual"/>.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// The value is identical to <seealso cref="Different"/>.
    /// </remarks>
    NotEqual = Different,
...
/// <summary>
/// Contains extensions for the <seealso cref="ComparisonKinds"/> enum.
/// </summary>
public static class ComparisonKindsExtensions
{
    ...
    {
        /// <summary>
        /// Gets the comparison kind from a <seealso cref="ComparisonResult"/>.
        /// </summary>
        /// <returns>
        /// A <seealso cref="ComparisonKinds"/> value with a single kind
        /// representing the given <seealso cref="ComparisonResult"/>.
        /// </returns>
    ...
    /// <summary>
    /// Determines whether a <seealso cref="ComparisonKinds"/> contains a
    /// comparison kind that matches the given
    /// <seealso cref="ComparisonResult"/>.
    /// </summary>
    /// <param name="kinds">
    /// The comparison kinds to determine whether they are satisfied by the
    /// result.
    /// </param>
    /// <param name="result">
    /// The
    /// </param>
    /// <returns>
    /// <see langword="true"/> if there is at least one comparison kind in
    /// <paramref name="kinds"/> that was matched by the
    /// <paramref name="result"/>, otherwise <see langword="false"/>.
    /// </returns>
    ...
    /// <summary>
    /// Determines whether a <seealso cref="ComparisonKinds"/> value contains
    /// the given kinds.
    /// </summary>
    /// <param name="kinds">
    ...
    /// </param>
    /// <param name="other">
    /// The requested comparison kinds to check if they are contained in the
    /// given <seealso cref="ComparisonKinds"/> value.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if <paramref name="kinds"/> contains at least all
    /// of the requested kinds in <paramref name="other"/>, otherwise
    /// <see langword="false"/>.
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>
    /// Converts the given comparison kind into a
    /// <seealso cref="ComparisonResult"/> value.
    /// </summary>
    /// <param name="kind">
    /// The single comparison kind that should be
    /// </param>
    /// <returns>
    /// The respective <seealso cref="ComparisonResult"/> value.
    /// </returns>
    /// <exception cref="ArgumentException">
    /// Thrown if <paramref name="kind"/> does not represent exactly a single
    /// comparison kind.
    /// </exception>
