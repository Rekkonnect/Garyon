...
/// <summary>
/// Provides the ability to store a reference to an unmanaged struct without
/// using pointers.
/// </summary>
/// <typeparam name="T">
/// The type of the unmanaged struct whose reference to store.
/// </typeparam>
    ...
    where T : unmanaged
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="StructRef{T}"/> class out
    /// of a reference to a struct instance.
    /// </summary>
    /// <param name="value">
    /// The struct instance whose reference to store initially.
    /// </param>
    ...
    /// </summary>
    /// <param name="value">
    /// The struct instance whose reference to store.
    /// </param>
    /// <remarks>
    ...
    /// </returns>
    /// <remarks>
    /// It is recommended to refer to the remarks of
    /// <seealso cref="SetReference(ref T)"/>.
    /// </remarks>
    public ref T GetReference() => ref *reference;
}

/// <summary>
/// Provides extensions related to <seealso cref="StructRef{T}"/>.
/// </summary>
public static class StructRefHelperExtensions
{
    /// <summary>
    /// Creates a new instance of the <seealso cref="StructRef{T}"/> class out
    /// of the desired struct instance reference.
    /// </summary>
    /// <typeparam name="T">
    ...
    /// </param>
    /// <returns>
    /// A <seealso cref="StructRef{T}"/> instance holding a reference to the
    /// passed struct instance reference.
    /// </returns>
