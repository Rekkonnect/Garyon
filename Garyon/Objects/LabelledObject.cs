...
public abstract class LabelledObject<T>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <seealso cref="LabelledObject{T}"/>
    /// class.
    /// </summary>
    /// <param name="value">
    ...
    /// <summary>
    /// Returns the string representation of this labelled object including its
    /// label.
    /// </summary>
    /// <returns>
    /// The string representation of the labelled object in the form
    /// <c>$"{Label}: {ObjectValue}"</c>.
    /// </returns>
