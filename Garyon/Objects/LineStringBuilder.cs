...
/// </summary>
/// <remarks>
/// Added strings are not checked for whether they're multiline or not, and are
...
public class LineStringBuilder
{
    ...
    /// <summary>
    /// Builds the resulting string by concatenating all the lines and
    /// delimiting them with newline characters.
    /// </summary>
    /// <returns>
