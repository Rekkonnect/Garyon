...
/// <summary>
/// Contains a set of <seealso cref="ConsoleColor"/> instances, for both the
/// background and the foreground colors.
/// </summary>
public struct ConsoleColorSet : IEquatable<ConsoleColorSet>
{
    /// <summary>
    /// Gets a new instance of the default <seealso cref="ConsoleColorSet"/>.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the color tuple, defined as (ForegroundColor,
    /// BackgroundColor).
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <seealso cref="ConsoleColorSet"/>
    /// struct from a foreground and a background color.
    /// </summary>
    ...
    /// <summary>
    /// Sets the colors to the specified values.
    /// </summary>
    /// <param name="foreground">
    ...
    /// </summary>
    /// <param name="obj">
    /// The object to determine whether this is equal to.
    /// </param>
    /// <returns>
    ...
    /// <summary>
    /// Gets the hash code for this instance, based on the color tuple.
    /// </summary>
    /// <returns>
