...
{
    /// <summary>
    /// Gets the current time's <seealso cref="HourMinute"/> representation.
    /// </summary>
    public static HourMinute Now => (HourMinute)DateTime.Now;
    /// <summary>
    /// Gets the <seealso cref="HourMinute"/> representation of the next minute
    /// from the current time.
    /// </summary>
    public static HourMinute NextMinute => Now + 1;
    /// <summary>
    /// Gets the <seealso cref="HourMinute"/> representation of the next hour
    /// from the current time.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the total hours as a <seealso cref="double"/>.
    /// </summary>
    ...
    {
        get => minutes / 60;
        set => minutes += (short)((value % 24 - Hour) * 60);
    }
    /// <summary>
    ...
    {
        get => minutes % 60;
        set => minutes += (short)(value % 60 - Minute);
    }
    
    /// <summary>
    /// Initializes a new instance of the <seealso cref="HourMinute"/> struct
    /// from the total minutes of the time.
    /// </summary>
    /// <param name="totalMinutes">
    /// The total minutes of the time.
    /// </param>
    public HourMinute(int totalMinutes) => minutes = (short)(totalMinutes % (24 * 60));
    /// <summary>
    /// Initializes a new instance of the <seealso cref="HourMinute"/> struct
    /// from the hour and the minute of the time.
    /// </summary>
    /// <param name="hour">
    ...
    /// <summary>
    /// Parses the given string representation of an hour-minute time into a
    /// <seealso cref="HourMinute"/> instance.
    /// </summary>
    /// <param name="s">
    /// The string representation of an hour-minute of the form "HH:MM". The
    /// string may contain additional numbers split with ":", which will be
    /// ignored.
    /// </param>
    /// <returns>
    /// The parsed <seealso cref="HourMinute"/> instance.
    /// </returns>
    ...
    /// <summary>
    /// Determines whether another <seealso cref="HourMinute"/> instance is
    /// equal to this one.
    /// </summary>
    /// <param name="other">
    /// The other <seealso cref="HourMinute"/> instance.
    /// </param>
    /// <returns>
