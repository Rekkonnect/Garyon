...
/// <summary>
/// Provides version information about the application, usually parsed
/// from <see cref="AssemblyInformationalVersionAttribute"/>.
/// </summary>
/// <param name="Version">
/// The main part of the informational version. Assuming a version
/// like '1.2.3-preview', the main version is the '1.2.3' part.
/// </param>
/// <param name="PreviewIndicator">
/// The optional preview indicator that follows the version string.
/// Assuming a version like '1.2.3-preview', the preview indicator
/// is the 'preview' part.
/// </param>
