...
/// <summary>
/// Provides extension functions for the <seealso cref="Extremum"/> enum.
/// </summary>
public static class ExtremumExtensions
{
    /// <summary>
    /// Gets the target comparison result that the extremum meets when compared
    ...
    /// </param>
    /// <returns>
    /// The <seealso cref="ComparisonResult"/> converted from the
    /// <seealso cref="Extremum"/>.
    /// </returns>
