...
/// The comparison kinds representing the direction of the open interval. It is
/// applied to the left side of the reference value, for instance &gt;= 4.
/// </param>
    ...
    where T : IComparable<T>
{
    ...
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the value is contained in the open interval,
    /// meaning that <paramref name="other"/> [comparison]
    /// <seealso cref="Value"/> is <see langword="true"/>, otherwise
    /// <see langword="false"/>.
    /// </returns>
    public bool Contains(T other) => other.SatisfiesComparison(Value, ComparisonKinds);

    /// <summary>
    /// Converts a value into an <seealso cref="OpenInterval{T}"/>, considering
    /// the open interval as the single value interval, ranging between the same
    /// value.
    /// </summary>
    /// <param name="value">
