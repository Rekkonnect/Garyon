...
/// <summary>
/// Provides extension methods for the <seealso cref="Type"/> class.
/// </summary>
public static class TypeExtensions
{
    ...
    #region General
    /// <summary>
    /// Gets the full name prefix of a generic type ignoring its arity, or the
    /// same full name if the type is not a generic type.
    /// </summary>
    /// <param name="type">
    /// The type whose full name prefix to get.
    /// </param>
    ...
    #region Inheritance
    /// <summary>
    /// Determines whether the provided type can inherit any type, either a
    /// class or an interface.
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it can inherit any type.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the type can inherit any type; that is, it is
    /// not a pointer or a by reference type, otherwise <see langword="false"/>.
    /// </returns>
    ...
    /// <returns>
    /// <see langword="true"/> if the type can inherit any type; that is, it is
    /// not a pointer, a by reference, a static class, a delegate, an enum or an
    /// array type, otherwise <see langword="false"/>.
    /// </returns>
    ...
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it can inherit any interface.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the type can inherit any interface; that is,
    /// it is not a pointer, a by reference, a static class, a delegate, an enum
    /// or an array type, otherwise <see langword="false"/>.
    /// </returns>
    ...
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it can inherit any class.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the type can inherit any interface; that is,
    /// it is not a pointer, a by reference, or a delegate type, otherwise
    /// <see langword="false"/>.
    /// </returns>
    ...
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it can inherit any custom class.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the type can inherit any interface; that is,
    /// it is not a pointer, a by reference, a static class, or a delegate type,
    ...
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it can be inherited.
    /// </param>
    /// <returns>
    /// A value determining whether <paramref name="type"/> can be inherited;
    /// that is, a non-sealed, thus non-static, class or an interface type.
    /// </returns>
    ...
    /// </summary>
    /// <typeparam name="T">
    /// The type to check whether it is being inherited by or equal to the
    /// provided <paramref name="type"/>.
    /// </typeparam>
    /// <param name="type">
    /// The type to determine whether it inherits or is equal to the type
    /// <typeparamref name="T"/>.
    /// </param>
    /// <returns>
    /// A value determining whether <paramref name="type"/> inherits or equals
    /// <typeparamref name="T"/>.
    /// </returns>
    ...
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it inherits or equals the type
    /// <paramref name="inherited"/>.
    /// </param>
    ...
    /// </summary>
    /// <typeparam name="T">
    /// The type to check whether it is being inherited by the provided
    /// <paramref name="type"/>.
    /// </typeparam>
    /// <param name="type">
    /// The type to determine whether it inherits the type
    /// <typeparamref name="T"/>.
    /// </param>
    /// <returns>
    /// A value determining whether <paramref name="type"/> inherits
    /// <typeparamref name="T"/>.
    /// </returns>
    ...
    /// </typeparam>
    /// <param name="type">
    /// The type to check if it implements the provided interface type. Must not
    /// be <see langword="null"/>.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the type implements the provided interface
    /// type, otherwise <see langword="false"/>.
    /// </returns>
    /// <exception cref="ArgumentException">
    /// <paramref name="type"/> is a type that cannot implement interfaces, or
    /// <typeparamref name="T"/> is not an interface.
    /// </exception>
    ...
    /// The type of the interface. Must not be <see langword="null"/>.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the type implements the provided interface
    /// type, otherwise <see langword="false"/>.
    ...
    /// <exception cref="ArgumentException">
    /// <paramref name="type"/> is a type that cannot implement interfaces, or
    /// <paramref name="interfaceType"/> is not an interface.
    /// </exception>
    ...
    /// </summary>
    /// <exception cref="ArgumentException">
    /// <paramref name="source"/> or <paramref name="target"/> is not an
    /// interface type, or <paramref name="source"/> cannot implement
    /// interfaces.
    /// </exception>
    ...
    /// <summary>
    /// Determines the number of base types that the provided type directly
    /// inherits, excluding the special classes <seealso cref="ValueType"/>,
    /// <seealso cref="Array"/>, <seealso cref="Delegate"/>,
    /// <seealso cref="Enum"/> and <seealso cref="Object"/>.
    /// </summary>
    /// <param name="type">
    /// The type whose inheritance level to determine.
    /// </param>
    /// <returns>
    /// The number of base types that the provided type inherits. For value
    /// types, pointers, arrays, and delegates this is equal to 0, and for
    /// reference types it is equal to the number of classes that are
    /// recursively directly inherited, excluding the <seealso cref="Object"/>
    /// class.
    /// </returns>
    ...
    /// <summary>
    /// Gets a <seealso cref="Tree{T}"/> representing the provided type's
    /// inheritance tree.
    /// </summary>
    /// <param name="type">
    /// The type whose inheritance tree to get.
    /// </param>
    /// <returns>
    /// A <seealso cref="Tree{T}"/> representing the provided type's inheritance
    /// tree.
    /// </returns>
    /// <remarks>
    /// The inheritance tree's root is the provided type, and the base classes
    /// are ancestors, which is the opposite than the proposed inheritance tree
    /// views, that have the deepest base object as the root, with each child
    /// being the inheritor.
    /// </remarks>
    ...
    /// </summary>
    /// <param name="type">
    /// The type whose interface inheritance tree to get.
    /// </param>
    /// <returns>
    /// A <seealso cref="Tree{T}"/> representing the provided type's interface
    /// inheritance tree. Each level only contains direct interface
    /// implementations, meaning that no node has nodes of indirectly inherited
    /// interfaces as direct children, they are indirect descendants though.
    /// </returns>
    ...
    /// <summary>
    /// Gets a the deepest interface inheritance level from the interface
    /// inheritance tree of the specified type.
    /// </summary>
    /// <param name="type">
    /// The type whose deepest interface inheritance level to get.
    /// </param>
    /// <returns>
    /// The deepest interface inheritance level. For pointers, by reference,
    /// delegate and enum types, this is equal to 0. For all the other types it
    /// is equal to the height of the interface inheritance tree.
    /// </returns>
    ...
    #region Generic
    /// <summary>
    /// Determines whether the provided type is a variant of the specified base
    /// generic type, or a definition that is equal to the provided generic type
    /// definition.
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it is a generic variant.
    /// </param>
    /// <param name="genericType">
    /// The base generic type.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if <paramref name="type"/> is a generic variant
    /// of or equal to <paramref name="genericType"/>, otherwise
    /// <see langword="false"/>.
    /// </returns>
    /// <exception cref="InvalidOperationException">
    /// The <paramref name="genericType"/> argument is not an unbound generic
    /// type.
    /// </exception>
    ...
    /// <returns>
    /// <see langword="true"/> if <paramref name="type"/> is a generic variant
    /// of <paramref name="genericType"/>, otherwise <see langword="false"/>.
    /// </returns>
    /// <exception cref="InvalidOperationException">
    /// The <paramref name="genericType"/> argument is not an unbound generic
    /// type.
    ...
    /// <summary>
    /// Determines whether the specified base generic type can be constructed
    /// into a type.
    /// </summary>
    /// <typeparam name="T">
    /// The type to determine whether it can be a construction of the base
    /// generic type.
    /// </typeparam>
    /// <param name="genericType">
    /// The base generic type.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if <paramref name="genericType"/> can be
    /// constructed into <typeparamref name="T"/>, otherwise
    /// <see langword="false"/>.
    /// </returns>
    /// <exception cref="InvalidOperationException">
    /// The <paramref name="genericType"/> argument is not an unbound generic
    /// type or the <typeparamref name="T"/> argument is not a bound generic
    /// type.
    /// </exception>
    ...
    /// The constructed type to determine whether it is constructed from the
    /// provided generic type.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if <paramref name="genericType"/> can be
    /// constructed into <paramref name="constructedType"/>, otherwise
    /// <see langword="false"/>.
    /// </returns>
    /// <exception cref="InvalidOperationException">
    /// The <paramref name="genericType"/> argument is not an unbound generic
    /// type or the <paramref name="constructedType"/> argument is not a bound
    /// generic type.
    /// </exception>
    ...
    /// </summary>
    /// <param name="type">
    /// The type whose generic type definition to get.
    /// </param>
    /// <returns>
    /// The generic type definition of the generic type, or the provided type
    /// itself if the type is not generic.
    /// </returns>
    ...
    /// <summary>
    /// Gets the declaring method of the given type. Only generic method type
    /// parameters support a declaring method.
    /// </summary>
    /// <param name="type">
    /// The type whose declaring method to get. It must be a generic method type
    /// parameter, otherwise <see langword="null"/> will be returned.
    /// </param>
    /// <returns>
    /// The declaring method for the given generic method type parameter, or
    /// <see langword="null"/> if the type is not a generic method type
    /// parameter.
    /// </returns>
    ...
    /// <summary>
    /// Gets the member that originally declares the given generic parameter
    /// type.
    /// </summary>
    /// <param name="type">
    /// The generic type parameter whose original declaring member to get.
    /// </param>
    /// <returns>
    /// The <seealso cref="MemberInfo"/> instance representing the member that
    /// originally declares the given generic parameter.
    /// </returns>
    /// <remarks>
    /// This method does not work for local generic methods.
    /// </remarks>
    /// <exception cref="ArgumentException">
    /// Thrown when <paramref name="type"/> is not a generic type parameter.
    /// </exception>
    ...
    /// </summary>
    /// <param name="type">
    /// The type that must inherit the target generic type.
    /// </param>
    /// <param name="genericDefinition">
    /// The generic definition that must be inherited.
    /// </param>
    /// <param name="genericVariantType">
    /// The constructed variant that is inherited. <see langword="null"/> if it
    /// doesn't exist.
    /// </param>
    /// <returns>
    ...
    /// generic type definition, that is it must not be a constructed generic
    /// type.
    /// </exception>
    ...
    /// <summary>
    /// Determines whether the type is <see langword="void"/>.
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it is <see langword="void"/>.
    /// </param>
    /// <returns>
    /// A value determining whether the type is <see langword="void"/>.
    /// </returns>
    public static bool IsVoid(this Type type) => type == typeof(void);
    /// <summary>
    /// Determines whether the type is an actual class, and not an array, a
    /// delegate, a by reference, or a pointer type.
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it is a class.
    /// </param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it is a static class.
    /// </param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it is a delegate.
    /// </param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it is an exception.
    /// </param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it is an attribute.
    /// </param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it is a tuple.
    /// </param>
    /// <returns>
    ...
    /// <summary>
    /// Determines whether the type is a nullable value type; that is, it is a
    /// <see cref="Nullable{T}"/> or a pointer type.
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it is a nullable value type.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the type is a nullable value type, otherwise
    /// <see langword="false"/>.
    /// </returns>
    public static bool IsNullableValueType(this Type type) => type.IsGenericVariantOrDefinition(typeof(Nullable<>)) || type.IsPointer;
    /// <summary>
    /// Determines whether the type is a nullable type; that is, it is a
    /// <see cref="Nullable{T}"/>, a pointer type or a reference type.
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it is a nullable type.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the type is a nullable type, either reference
    /// or value type, otherwise <see langword="false"/>.
    /// </returns>
    public static bool IsNullableType(this Type type) => type.IsReferenceType() || type.IsNullableValueType() || type.IsPointer;
    /// <summary>
    /// Determines whether the type is a reference type; that is, not a value
    /// type, or a pointer type.
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it is a reference type.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the type is a class or an interface, otherwise
    /// <see langword="false"/>.
    /// </returns>
    ...
    /// </summary>
    /// <param name="type">
    /// The type to determine whether it is a valid type argument.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if the type is a valid type argument, that is, it
    /// is not a by ref, a by ref-like, a pointer, or <see langword="void"/>,
    /// otherwise <see langword="false"/>.
    /// </returns>
    ...
    /// </summary>
    /// <param name="type">
    /// The type of the elements within the array.
    /// </param>
    /// <param name="jaggingLevel">
    /// The jagging level of the resulting jagged array type.
    /// </param>
    /// <returns>
    /// The resulting <seealso cref="Type"/> object representing a jagged array
    /// type.
    /// </returns>
    ...
    /// <summary>
    /// Creates a jagged array type object with the specified ranks for each
    /// jag.
    /// </summary>
    /// <param name="type">
    /// The type of the elements within the array.
    /// </param>
    /// <param name="ranks">
    /// The ranks for each jagging level of the array type. The order is
    /// preserved like this: { 1, 2, 3 } => T[][,][,,].
    /// </param>
    /// <returns>
    /// The resulting <seealso cref="Type"/> object representing a jagged array
    /// type.
    ...
    /// </summary>
    /// <param name="type">
    /// The jagged array type.
    /// </param>
    /// <returns>
    /// The jagging level of the jagged array, if the provided type is an array,
    /// otherwise 0.
    /// </returns>
    ...
    #region Pointers
    /// <summary>
    /// Creates a multiple pointer type object with the specified pointer depth
    /// level.
    /// </summary>
    /// <param name="type">
    /// The type of the elements within the pointer.
    /// </param>
    /// <param name="pointerDepthLevel">
    /// The depth level of the resulting pointer type.
    /// </param>
    /// <returns>
    /// The resulting <seealso cref="Type"/> object representing a pointer type.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    /// The depth level of the multiple pointer, if the provided type is a
    /// pointer, otherwise 0.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    /// The deepest element type according to
    ...
    /// The type of the elements that the provided type should contain.
    /// </param>
    /// <returns>
    ...
    #region Instances
    /// <summary>
    /// Gets the public parameterless constructor of the <see cref="Type"/>.
    /// </summary>
    /// <param name="type">
    /// The type whose public parameterless constructor to get.
    /// </param>
    /// <returns>
    /// The public parameterless constructor of the type, or
    /// <see langword="null"/> if the type does not have one, or if the
    /// parameterless constructor is not public.
    /// </returns>
    ...
    /// <summary>
    /// Gets the parameterless constructor of the <see cref="Type"/>. The
    /// constructor may have any accessibility.
    /// </summary>
    /// <param name="type">
    /// The type whose parameterless constructor to get.
    /// </param>
    /// <returns>
    /// The parameterless constructor of the type, or <see langword="null"/> if
    ...
    /// <summary>
    /// Gets the constructor with the specified argument types of the
    /// <see cref="Type"/>.
    /// </summary>
    /// <param name="type">
    /// The type whose constructor to get.
    /// </param>
    /// <param name="argumentTypes">
    /// The argument types of the constructor to get.
    /// </param>
    /// <returns>
    /// The constructor of the type, or <see langword="null"/> if the type does
    /// not have one.
    /// </returns>
    ...
    /// <summary>
    /// Gets the constructor with the specified argument types of the
    /// <see cref="Type"/>. The constructor may have any accessibility.
    /// </summary>
    /// <param name="type">
    /// The type whose constructor to get.
    /// </param>
...
#pragma warning disable CS1712
    ...
    /// </summary>
    /// <typeparam name="T1">
    /// The type of the 1st argument of the constructor to get.
    /// </typeparam>
    /// <param name="type">
    /// The type whose constructor to get.
    /// </param>
    ...
    /// <summary>
    /// Gets the constructor of the <see cref="Type"/> that has 2 arguments and
    /// whose argument types are in the order they are provided in the type
    /// arguments.
    /// </summary>
    /// <inheritdoc cref="GetConstructor{T1}(Type)"/>
    /// <typeparam name="T2">
    /// The type of the 2nd argument of the constructor to get.
    /// </typeparam>
    [Autogenerated]
    ...
    /// <summary>
    /// Gets the constructor of the <see cref="Type"/> that has 3 arguments and
    /// whose argument types are in the order they are provided in the type
    /// arguments.
    /// </summary>
    /// <inheritdoc cref="GetConstructor{T1, T2}(Type)"/>
    /// <typeparam name="T3">
    /// The type of the 3rd argument of the constructor to get.
    /// </typeparam>
    [Autogenerated]
    ...
    /// <summary>
    /// Gets the constructor of the <see cref="Type"/> that has 4 arguments and
    /// whose argument types are in the order they are provided in the type
    /// arguments.
    /// </summary>
    /// <inheritdoc cref="GetConstructor{T1, T2, T3}(Type)"/>
    /// <typeparam name="T4">
    /// The type of the 4th argument of the constructor to get.
    /// </typeparam>
    [Autogenerated]
...
#pragma warning restore
    ...
    /// <summary>
    /// Initializes a new instance of a <seealso cref="Type"/> by calling its
    ...
    /// </param>
    /// <returns>
    /// The initialized instance, or <see langword="null"/> if no public
    /// parameterless constructor was not found.
    /// </returns>
    ...
    /// <summary>
    /// Initializes a new instance of a <seealso cref="Type"/> with the given
    ...
    /// </param>
    /// <returns>
    /// The initialized instance, or <see langword="null"/> if such a
    ...
    /// </param>
    /// <returns>
    /// Returns the default value of the type, if it is a value type, by calling
    /// its parameterless constructor is called, otherwise
    /// <see langword="null"/>.
    /// </returns>
