...
/// <summary>
/// Contains extensions for the <seealso cref="AppDomain"/> type.
/// </summary>
public static class AppDomainExtensions
{
    /// <summary>
    /// Gets all the types defined in all assemblies for the given
    /// <seealso cref="AppDomain"/>.
    /// </summary>
    /// <param name="domain">
    /// The <seealso cref="AppDomain"/> whose types to get.
    /// </param>
    public static IEnumerable<Type> GetAllTypes(this AppDomain domain) => domain.GetAssemblies().SelectMany(domain => domain.GetTypes());

    /// <summary>
    /// Gets and filters all the types defined in all assemblies for the given
    /// <seealso cref="AppDomain"/>.
    /// </summary>
    /// <param name="domain">
    /// The <seealso cref="AppDomain"/> whose types to get.
