...
/// <summary>
/// Provides a mechanism to initialize default instances of a type, including
/// deriving types.
/// </summary>
    ...
    where TBase : class
{
    ...
    /// <summary>
    /// Gets all the default instance types that were found in all the
    /// assemblies this program can refer to.
    /// </summary>
    ...
    /// <seealso cref="GetDefaultInstanceArguments"/>. For
    /// <see langword="null"/> objects, the <seealso cref="object"/> type is
    /// used.
    /// </remarks>
    ...
    /// <summary>
    /// Initializes a new <seealso cref="DefaultInstanceContainer{TBase}"/>
    /// instance with all the types available from
    /// <seealso cref="AppDomainCache.Current"/>, filtered through
    /// <seealso cref="IsValidInstanceType(Type)"/>.
    /// </summary>
    /// <remarks>
    /// All types that are considered valid must contain a constructor matching
    /// the argument types as returned from
    /// <seealso cref="GetDefaultInstanceArgumentTypes"/>.
    /// </remarks>
    ...
    /// <summary>
    /// Determines whether the given type can be considered a valid instance
    /// type.
    /// </summary>
    /// <param name="type">
    /// The instance type to determine whether it is considered valid. The type
    /// will never be <see langword="abstract"/>, and will always be assignable
    /// to <typeparamref name="TBase"/> instances.
    /// </param>
    /// <returns>
    ...
    /// </returns>
    /// <remarks>
    /// Defaults to always returning <see langword="true"/>. This can be a
    /// common implementation for unconstrained types whose default instances to
    /// initialize.
    /// </remarks>
    ...
    /// </typeparam>
    /// <returns>
    /// The default initialized instance of the type, if it is initialized,
    ...
    /// <summary>
    /// Gets the default initialized instance of the type bearing the given type
    /// name.
    /// </summary>
    /// <param name="typeName">
