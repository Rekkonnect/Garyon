...
/// <summary>
/// Contains information about the definition of a <seealso cref="Type"/>.
/// </summary>
public class TypeDefinitionInfo : BaseEquatable<TypeDefinitionInfo>
{
    ...
    /// <summary>
    /// Determines whether the type is either a class or an array. For the
    /// non-array variant, use <see cref="IsTrueClass"/>.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether the type is a reference type; that is, any class,
    /// interface, delegate or by reference type. Pointers do not count as
    /// reference types.
    /// </summary>
    public bool IsReferenceType => IsClass || IsInterface || IsDelegate || IsByRef;
    /// <summary>
    /// Determines whether the type is a reference type; that is, any struct,
    /// enum, tuple or pointer type.
    /// </summary>
    public bool IsValueType => IsStruct || IsEnum || IsTuple || IsPointer;
    /// <summary>
    /// Determines whether the type is a nullable value type; that is, any
    /// nullable struct or pointer type.
    /// </summary>
    public bool IsNullableValueType => IsNullableStruct || IsPointer;
    /// <summary>
    /// Determines whether the type is a nullable type; that is, any reference,
    /// nullable struct or pointer type.
    /// </summary>
    public bool IsNullableType => IsReferenceType || IsNullableValueType;

    /// <summary>
    /// Determines whether the type is <see langword="public"/>.
    /// </summary>
    public bool IsPublic => Modifiers.HasFlag(TypeModifiers.Public);
    /// <summary>
    /// Determines whether the type is <see langword="internal"/>.
    /// </summary>
    public bool IsInternal => Modifiers.HasFlag(TypeModifiers.Internal);
    /// <summary>
    /// Determines whether the type is <see langword="protected internal"/>.
    /// </summary>
    public bool IsProtectedInternal => Modifiers.HasFlag(TypeModifiers.ProtectedInternal);
    /// <summary>
    /// Determines whether the type is <see langword="protected"/>.
    /// </summary>
    public bool IsProtected => Modifiers.HasFlag(TypeModifiers.Protected);
    /// <summary>
    /// Determines whether the type is <see langword="private protected"/>.
    /// </summary>
    public bool IsPrivateProtected => Modifiers.HasFlag(TypeModifiers.PrivateProtected);
    /// <summary>
    /// Determines whether the type is <see langword="private"/>.
    /// </summary>
    public bool IsPrivate => Modifiers.HasFlag(TypeModifiers.Private);
    /// <summary>
    /// Determines whether the type is <see langword="file"/>.
    /// </summary>
    public bool IsFile => Modifiers.HasFlag(TypeModifiers.File);

    /// <summary>
    /// Determines whether the type is <see langword="static"/>.
    /// </summary>
    public bool IsStatic => Modifiers.HasFlag(TypeModifiers.Static);
    /// <summary>
    /// Determines whether the type is <see langword="abstract"/>.
    /// </summary>
    public bool IsAbstract => Modifiers.HasFlag(TypeModifiers.Abstract);
    /// <summary>
    /// Determines whether the type is <see langword="sealed"/>.
    /// </summary>
    public bool IsSealed => Modifiers.HasFlag(TypeModifiers.Sealed);
    /// <summary>
    /// Determines whether the type is <see langword="ref"/>. NOTE: This
    /// property will always return <see langword="false"/> for ref struct type
    /// definitions, since the reflection API does not have any mechanism to
    /// determine that. However, by ref types (types with the ref modifier in
    /// argument type declarations) will be detected as such.
    /// </summary>
    public bool IsRef => Modifiers.HasFlag(TypeModifiers.Ref);
    /// <summary>
    /// Determines whether the type is <see langword="readonly"/>. NOTE: This
    /// property will always return <see langword="false"/> since the reflection
    /// API does not have any mechanism to determine that.
    /// </summary>
    public bool IsReadonly => Modifiers.HasFlag(TypeModifiers.Readonly);
    /// <summary>
    /// Determines whether the type is <see langword="readonly ref"/>. NOTE:
    /// This property will always return <see langword="false"/> since the
    ...
    #region Inheritance
    /// <summary>
    /// Determines whether this type can inherit any type, either a class or an
    /// interface.
    /// </summary>
    /// <returns>
    ...
    /// </summary>
    /// <returns>
    /// <see langword="true"/> if the type can be inherited by any type; that is
    /// it is not sealed, is a true class or an interface, otherwise
    /// <see langword="false"/>.
    /// </returns>
    ...
    /// <summary>
    /// Initializes a new instance of the <seealso cref="TypeDefinitionInfo"/>
    /// class.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <seealso cref="TypeDefinitionInfo"/>
    /// class from a type kind and the type modifiers.
    /// </summary>
    /// <param name="kind">
    /// The kind of the type.
    /// </param>
    ...
    /// </param>
    /// <returns>
    /// A <seealso cref="TypeKind"/> which determines the type's type kind.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    /// A <seealso cref="TypeModifiers"/> value that contains the type
    /// modifiers.
    /// </returns>
