...
/// <summary>
/// Contains extension methods for the <seealso cref="MemberInfo"/> class.
/// </summary>
public static class MemberInfoExtensions
{
    ...
    {
        /// <summary>
        /// Gets the arity of the member represented by the given
        /// <seealso cref="MemberInfo"/> instance.
        /// </summary>
        /// <returns>
        /// The arity of the member, if it is either a
        /// <seealso cref="MethodInfo"/> or a <seealso cref="Type"/>. Otherwise,
        /// returns 0.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        /// If the given <seealso cref="MemberInfo"/> is a
        /// <seealso cref="Type"/>, the type itself is returned. Otherwise,
        /// depending on the type of the <seealso cref="MemberInfo"/> instance,
        ...
        ///     </item>
        ///     <item>
        ///     <seealso cref="EventInfo.EventHandlerType"/>
        ///     </item>
        ///     <item>
        ...
        /// <summary>
        /// Determines whether a member has a custom attribute of the specified
        /// type.
        /// </summary>
        ...
        /// The first instance of the attribute that is found, if any, otherwise
        /// <see langword="null"/>.
        /// </param>
        /// <returns>
        /// A value indicating whether the requested attribute was found.
        /// </returns>
        ...
        /// <summary>
        /// Determines whether a member has custom attributes of the specified
        /// type.
        /// </summary>
        /// <param name="attributeType">
        /// The type of the attribute to find.
        ...
        /// A collection of instances of the attributes that were found. If no
        /// attributes were found, the collection is empty.
        /// </param>
        /// <returns>
        /// A value indicating whether the requested attribute was found at
        /// least once.
        /// </returns>
        ...
        /// </summary>
        /// <typeparam name="T">
        /// The type of the attributes to find.
        /// </typeparam>
        /// <param name="instances">
        /// A collection of instances of the attributes that were found. If no
        /// attributes were found, the collection is empty.
        ...
        /// <summary>
        /// Gets the value of a field or property <seealso cref="MemberInfo"/>.
        /// </summary>
        /// <param name="instance">
        /// The instance on which to get the value of the field or property, or
        /// <see langword="null"/> if it's a <see langword="static"/> one.
        /// </param>
        /// <returns>
        /// The value returned by the field or property on the given instance.
        /// </returns>
        /// <exception cref="InvalidOperationException">
        /// The given <seealso cref="MemberInfo"/> is not a
        /// <seealso cref="FieldInfo"/> or a <seealso cref="PropertyInfo"/>.
        /// </exception>
