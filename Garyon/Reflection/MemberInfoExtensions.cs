...
public static class MemberInfoExtensions
{
    ...
    public static bool HasCustomAttribute(this MemberInfo member, Type attributeType, out Attribute firstInstance)
    {
    ...
    public static bool HasCustomAttributes(this MemberInfo member, Type attributeType, out IEnumerable<Attribute> instances)
    {
        ...
        where TMemberInfo : MemberInfo
    {
        ...
        {
            if (member.HasCustomAttributes<TAttribute>(out var attributes))
            {
        ...
        where TMemberInfo : MemberInfo
    {
        ...
        foreach (var member in members)
        {
            ...
            {
                foreach (var attribute in attributes)
                    result.Add(selector(attribute), member);
            }
        }
    ...
    /// instance.
    /// </summary>
    /// <param name="member">The member whose type to get.</param>
    /// <returns>
