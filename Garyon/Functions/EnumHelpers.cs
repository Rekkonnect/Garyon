...
public static class EnumHelpers
{
    ...
    /// </typeparam>
    /// <returns>
    /// An array of type <typeparamref name="T"/>[] which contains all the
    /// values contained in the <typeparamref name="T"/> enum.
    /// </returns>
    ...
    /// <summary>
    /// Parses the value of an enum type.
    /// </summary>
    /// <typeparam name="T">
    /// The type of the enum.
    /// </typeparam>
    /// <param name="name">
    /// The name of the field in the enum.
    /// </param>
    /// <returns>
    /// The parsed value cast to the enum type that was specified.
    /// </returns>
    ...
    /// Determines whether to ignore the case of the name to parse.
    /// </param>
    /// <returns>
    /// The parsed value cast to the enum type that was specified.
    /// </returns>
    ...
    /// </summary>
    /// <typeparam name="T">
    /// The enum type whose entry count to get.
    /// </typeparam>
    /// <returns>
    /// The number of entries defined in the enum type.
    /// </returns>
    /// <remarks>
    /// This function has a O(1) time complexity, contrast to
    /// <seealso cref="GetEntryCount(Type)"/>, since the count is stored as a
    /// runtime constant. Thus, prefer calling this function wherever possible.
    /// </remarks>
    ...
    /// The provided type is <see langword="null"/>, or not an enum type.
    /// </exception>
    /// <returns>
    /// The number of entries defined in the enum type.
    /// </returns>
    /// <remarks>
    /// This function has a O(n) time complexity if the provided type has not
    /// been evaluated with either this, or the
    /// <seealso cref="GetEntryCount{T}"/> function, otherwise it has a O(1)
    /// complexity. Thus, prefer calling the <seealso cref="GetEntryCount{T}"/>
    ...
    /// <summary>
    /// Discovers all enum types from all the loaded assemblies, using
    /// <seealso cref="AppDomainCache.Current"/>, and statically registers their
    /// entry counts.
    /// </summary>
    /// <remarks>
    ...
    /// registers their entry counts.
    /// </summary>
    /// <param name="assembly">
    /// The assembly whose enum types to discover.
    /// </param>
    /// <remarks>
    ...
    /// </summary>
    /// <param name="types">
    /// The collection of types, from which the enum types' entry counts will be
    /// registered.
    /// </param>
    /// <remarks>
    ...
    /// The underlying type of the enum, which is the type of the value
    /// instances.
    /// </typeparam>
    /// <param name="value">
    /// The integral value to determine whether it's defined in an enum.
    /// </param>
    /// <returns>
    /// <see langword="true"/> if <typeparamref name="TEnum"/> has a definition
    /// assigned to the specified integral value, otherwise
    /// <see langword="false"/>.
    /// </returns>
    /// <remarks>
    /// The function is based on <seealso cref="Enum.IsDefined(Type, object)"/>.
    /// </remarks>
#endif
    ...
    /// <summary>
    /// Determines whether <typeparamref name="TEnum"/>'s underlying value type
    /// is <typeparamref name="TUnderlying"/>.
    /// </summary>
    /// <typeparam name="TEnum">
    /// The type of the enum.
    /// </typeparam>
    ...
    /// </typeparam>
    /// <returns>
    /// <see langword="true"/> if <typeparamref name="TEnum"/> stores values of
    /// type <typeparamref name="TUnderlying"/>, otherwise
    /// <see langword="false"/>.
    /// </returns>
