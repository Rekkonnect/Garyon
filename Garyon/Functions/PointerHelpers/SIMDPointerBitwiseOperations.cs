...
{
    private interface ISIMDBitwiseOperation<T> : ISIMDOperation
        where T : unmanaged
    {
        public abstract void IterateRemainingElements(T* origin, T* target, uint index, uint length);
        public abstract void PerformIteration(T* origin, T* target, uint index);
    }
        ...
        where T : unmanaged
    {
        ...
        {
            BitwiseOperation.AND => ANDArrayVector256,
            BitwiseOperation.OR => ORArrayVector256,
            BitwiseOperation.XOR => XORArrayVector256,
            BitwiseOperation.NAND => NANDArrayVector256,
            BitwiseOperation.NOR => NORArrayVector256,
            BitwiseOperation.XNOR => XNORArrayVector256,
            _ => null,
        };
    }
    #endregion
