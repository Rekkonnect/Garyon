...
/// <summary>
/// Contains utilities for the <seealso cref="Console"/> class.
/// </summary>
/// <remarks>
/// You can also use them directly by accessing the <see cref="Console"/> class,
/// as they are defined as static extensions.
/// </remarks>
public static class ConsoleUtilities
{
    extension(Console)
    {
        ...
        /// <summary>
        /// Sets the console colors to specified values.
        /// </summary>
        /// <param name="foreground">
        /// The foreground color set to set.
        /// </param>
        /// <param name="background">
        /// The background color set to set.
        /// </param>
        ...
        /// <summary>
        /// Sets the console colors to a specified
        /// <seealso cref="ConsoleColorSet"/>'s colors.
        /// </summary>
        /// <param name="set">
        /// The console color set to set.
        /// </param>
        ...
        /// </summary>
        /// <returns>
        /// A <seealso cref="ConsoleColorSet"/> containing the current console
        /// colors.
        /// </returns>
        ...
        /// </summary>
        /// <param name="e">
        /// The exception whose information to write.
        /// </param>
        ...
        /// <summary>
        /// Writes text to the console and optionally reset the console color
        /// after writing.
        /// </summary>
        /// <param name="text">
        /// The text to write to the console.
        /// </param>
        /// <param name="resetColor">
        /// Resets the console color after writing the text, if set to
        /// <see langword="true"/>.
        /// </param>
        ...
        /// <summary>
        /// Writes text to the console, appends a newline after the written text
        /// and optionally reset the console color after writing.
        /// </summary>
        /// <param name="text">
        /// The text to write to the console.
        /// </param>
        ...
        /// <summary>
        /// Writes text to the console with a specified foreground color.
        /// </summary>
        /// <param name="text">
        /// The text to write to the console.
        /// </param>
        /// <param name="color">
        /// The foreground color to set before writing the text.
        /// </param>
        /// <param name="resetColor">
        /// Resets the console color after writing the text, if set to
        /// <see langword="true"/>.
        ...
        /// <summary>
        /// Writes text to the console with a specified color.
        /// </summary>
        /// <param name="text">
        /// The text to write to the console.
        /// </param>
        /// <param name="color">
        /// The color to set before writing the text.
        /// </param>
        /// <param name="resetColor">
        /// Resets the console color after writing the text, if set to
        /// <see langword="true"/>.
        ...
        /// <summary>
        /// Writes text to the console with a specified foreground color and
        /// appends a newline after the specified text.
        /// </summary>
        /// <param name="text">
        /// The text to write to the console.
        /// </param>
        ...
        /// <summary>
        /// Writes text to the console with a specified color and appends a
        /// newline after the specified text.
        /// </summary>
        /// <param name="text">
        /// The text to write to the console.
        /// </param>
        ...
        /// <summary>
        /// Writes a text with the specified foreground color, optionally adds a
        /// newline after text and optionally resets the color after writing.
        /// </summary>
        /// <param name="text">
        /// The text to write.
        /// </param>
        ...
        /// <see langword="true"/>.
        /// </param>
        /// <param name="newlineAfterText">
        /// Adds a newline after the written text, if set to
        /// <see langword="true"/>.
        /// </param>
        ...
        /// <summary>
        /// Writes a text with the specified color, optionally adds a newline
        /// after text and optionally resets the color after writing.
        /// </summary>
        /// <param name="text">
        /// The text to write.
        /// </param>
        ...
        #region Input
        /// <summary>
        /// Reads a line from the console and optionally reset the console color
        /// after reading.
        /// </summary>
        /// <param name="resetColor">
        /// Resets the console color after reading the line, if set to
        /// <see langword="true"/>.
        /// </param>
        /// <returns>
        /// The input string that was given.
        /// </returns>
        ...
        /// <summary>
        /// Reads a line from the console with a specified foreground color.
        /// </summary>
        /// <param name="color">
        /// The foreground color to set before reading the line.
        /// </param>
        /// <param name="resetColor">
        /// Resets the console color after reading the line, if set to
        /// <see langword="true"/>.
        ...
        /// <summary>
        /// Reads a line from the console with a specified color.
        /// </summary>
        /// <param name="color">
        /// The color to set before reading the line.
        /// </param>
        /// <param name="resetColor">
        /// Resets the console color after reading the line, if set to
        /// <see langword="true"/>.
        ...
        /// <summary>
        /// Requests input from the console, providing a request message before
        /// doing so, with a specified foreground color for both input and
        /// output, separately provided.
        /// </summary>
        /// <param name="requestMessage">
        /// The message to write before requesting input.
        /// </param>
        /// <param name="outputColor">
        /// The foreground color of the message.
        /// </param>
        /// <param name="inputColor">
        /// The foreground color of the input.
        /// </param>
        /// <param name="resetColor">
        /// Determines whether the color will be reset after performing the
        /// operation.
        /// </param>
        /// <param name="newlineAfterMessage">
        /// Determines whether a newline should be added after the message.
        /// </param>
        /// <returns>
        /// The input string that was given.
        /// </returns>
        ...
        /// <summary>
        /// Requests input from the console, providing a request message before
        /// doing so, with a specified color for both input and output,
        /// separately provided.
        /// </summary>
        /// <param name="requestMessage">
        /// The message to write before requesting input.
        ...
        // Currently reported as unused, tracked by
        // https://github.com/dotnet/roslyn/issues/81657
