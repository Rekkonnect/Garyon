...
/// <summary>
/// Provides methods for quickly checking against nullability for multiple
/// objects simultaneously.
/// </summary>
[ExcludeFromCodeCoverage]
public static class NullGuards
{
    public static bool AnyNull<T1, T2>(
        [NotNullWhen(false)] T1? value1,
        [NotNullWhen(false)] T2? value2)
    {
        return value1 is null
            || value2 is null;
    }
    public static bool AnyNull<T1, T2, T3>(
        [NotNullWhen(false)] T1? value1,
        [NotNullWhen(false)] T2? value2,
        [NotNullWhen(false)] T3? value3)
    {
        return value1 is null
            || value2 is null
            || value3 is null;
    }
    public static bool AnyNull<T1, T2, T3, T4>(
        [NotNullWhen(false)] T1? value1,
        [NotNullWhen(false)] T2? value2,
        [NotNullWhen(false)] T3? value3,
        [NotNullWhen(false)] T4? value4)
    {
        return value1 is null
            || value2 is null
            || value3 is null
    ...
    public static bool NoneNull<T1, T2>(
        [NotNullWhen(true)] T1? value1,
        [NotNullWhen(true)] T2? value2)
    {
        return !AnyNull(value1, value2);
    }
    public static bool NoneNull<T1, T2, T3>(
        [NotNullWhen(true)] T1? value1,
        [NotNullWhen(true)] T2? value2,
        [NotNullWhen(true)] T3? value3)
    {
        return !AnyNull(value1, value2, value3);
    }
    public static bool NoneNull<T1, T2, T3, T4>(
        [NotNullWhen(true)] T1? value1,
        [NotNullWhen(true)] T2? value2,
        [NotNullWhen(true)] T3? value3,
        [NotNullWhen(true)] T4? value4)
    {
