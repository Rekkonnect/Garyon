...
{
    /// <summary>
    /// Rescales a value into a different type. The returned value includes as
    /// many bytes as the target type allows from the original type, with the
    /// rest, if any, set to 0.
    /// </summary>
